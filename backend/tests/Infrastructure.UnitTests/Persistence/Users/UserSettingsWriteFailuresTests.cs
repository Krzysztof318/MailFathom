...
/// <summary>
/// Covers what a failed write of one user's record tells the operator. A write says more than a read has to, because
...
/// again blind.
/// </summary>
public sealed class UserSettingsWriteFailuresTests
{
    ...
    public void Diagnose_PrivilegeRefused_SendsTheOperatorToTheUpdateGrant()
    {
        ...
        // Act
        var diagnosis = UserSettingsWriteFailures.Diagnose(exception);
    ...
    public void DiagnoseWhileConnecting_TimeoutExpired_ReportsTheRecordAsUnchanged()
    {
        ...
        // Act
        var diagnosis = UserSettingsWriteFailures.DiagnoseWhileConnecting(exception);
