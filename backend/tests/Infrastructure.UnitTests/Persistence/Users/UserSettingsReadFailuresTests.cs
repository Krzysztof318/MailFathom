...
/// <summary>
/// Covers what a failed read of one user's record tells the operator. The read itself needs a database, but which
...
/// </summary>
public sealed class UserSettingsReadFailuresTests
{
    ...
    public void DiagnoseWhileReading_TableDoesNotExist_SendsTheOperatorToTheMigrations()
    {
        ...
        // Act
        var diagnosis = UserSettingsReadFailures.DiagnoseWhileReading(exception);
    ...
    public void DiagnoseWhileConnecting_TimeoutExpired_ReportsTheDatabaseAsUnreached()
    {
        ...
        // Act
        var diagnosis = UserSettingsReadFailures.DiagnoseWhileConnecting(exception);
    ...
    public void DiagnoseWhileConnecting_AStateTheServerAnswered_SaysWhatTheStatementWould(string sqlState, string expected)
    {
        ...
        Assert.Equal(UserSettingsReadFailures.DiagnoseWhileReading(exception), diagnosis);
    }
