...
/// </remarks>
public sealed class MailUserClocksTests
{
    ...
    {
        // Arrange
        var clock = MailUserClocks.Reading(Instant);
    ...
    {
        // Arrange
        var clock = MailUserClocks.Reading(Instant, "Asia/Tokyo");
    ...
    {
        // Act
        var refusal = Assert.Throws<ArgumentException>(() => MailUserClocks.Reading(Instant, "Europe/Warszawa"));
