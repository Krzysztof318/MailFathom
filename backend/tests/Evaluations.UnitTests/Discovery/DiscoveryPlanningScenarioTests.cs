...
public sealed class DiscoveryPlanningScenarioTests : IDisposable
{
    ...
    [InlineData("NoScope", """{"intent":"findFact","sufficientPassages":3,"lookups":[{"queryText":"offsite venue","receivedOnOrAfter":"2026-01-01T00:00"}]}""", false)]
    ...
    [InlineData("NamesPeriod", """{"intent":"findFact","sufficientPassages":4,"lookups":[{"queryText":"rent increase","receivedOnOrAfter":"2026-03-01T00:00","receivedBefore":"2026-04-01T00:00"}]}""", true)]
    ...
    [InlineData("NamesADateRange", """{"intent":"findDocuments","sufficientPassages":5,"lookups":[{"queryText":"Brightwater invoice","receivedOnOrAfter":"2026-08-01T00:00","receivedBefore":"2026-08-16T00:00"}]}""", true)]
    [InlineData("NamesADateRange", """{"intent":"findDocuments","sufficientPassages":5,"lookups":[{"queryText":"Brightwater invoice","receivedOnOrAfter":"2026-08-01T00:00","receivedBefore":"2026-09-01T00:00"}]}""", false)]
    ...
    [InlineData("Polish.NoScope", """{"intent":"findFact","sufficientPassages":3,"lookups":[{"queryText":"miejsce wyjazdu","receivedOnOrAfter":"2026-01-01T00:00"}]}""", false)]
    ...
    [InlineData("Polish.NamesPeriod", """{"intent":"findFact","sufficientPassages":4,"lookups":[{"queryText":"podwyżka czynszu","receivedOnOrAfter":"2026-03-01T00:00","receivedBefore":"2026-04-01T00:00"}]}""", true)]
