...
/// </para>
/// <para>
/// It is registered rather than left out because <c>MailUserClock</c> resolves it, and every operation that anchors a
...
/// </para>
/// </remarks>
internal sealed class OrchestratedMailUserTimeZones : IMailUserTimeZones
{
    /// <inheritdoc />
    public MailUserTimeZone ZoneOf(MailUserId user) => MailUserTimeZone.Coordinated;

    /// <inheritdoc />
    public MailUserTimeZone? StatedZoneOf(MailUserId user) => null;
}
