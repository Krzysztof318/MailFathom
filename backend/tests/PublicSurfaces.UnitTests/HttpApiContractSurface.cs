...
internal static class HttpApiContractSurface
{
    ...
    [
        ...
        new("AdminEndpoint:Administrators:1:Credentials:0:OAuth:Resource", $"https://mailfathom.example.test{AdminEndpointOptions.RoutePrefix}"),
        new("AdminEndpoint:Administrators:1:Credentials:0:OAuth:AuthorizationServers:0:Name", "example-issuer"),
        new("AdminEndpoint:Administrators:1:Credentials:0:OAuth:AuthorizationServers:0:Issuer", "https://issuer.example.test"),
        new("AdminEndpoint:Administrators:1:Credentials:0:OAuth:AuthorizationServers:0:AuthorizedSubjects:0", "not-a-real-subject"),
