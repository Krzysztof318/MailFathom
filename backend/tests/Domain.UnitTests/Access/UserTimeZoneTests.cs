...
public sealed class UserTimeZoneTests
{
    ...
    {
        // Act
        var read = UserTimeZone.TryRead(zoneId, out var zone);
    ...
    public void TryRead_AnIdentifierLongerThanAZoneIdentifierMayBe_IsRefused()
    {
        ...
        // Act
        var read = UserTimeZone.TryRead(overLong, out var zone);
    ...
    {
        // Act
        var zone = UserTimeZone.Coordinated;
    ...
    {
        // Arrange
        Assert.True(UserTimeZone.TryRead(zoneId, out var zone));
    ...
    {
        // Act
        var read = UserTimeZone.TryRead("  Europe/Warsaw  ", out var zone);
