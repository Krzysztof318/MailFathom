...
public sealed class UserIdTests
{
    ...
    {
        // Arrange & Act
        var unspecified = default(UserId);
    ...
    public void Equals_TwoIdentitiesOverOneIdentifier_AreTheSameUser()
    {
        ...
        // Act
        var user = UserId.Create(value);
        var sameUser = UserId.Create(value);

        // Assert
        Assert.Equal(user, sameUser);
        Assert.NotEqual(user, UserId.Create(new Guid("0198f0aa-0000-7000-8000-0000000000a3")));
    }
}
