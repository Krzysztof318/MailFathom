...
{
    private readonly Dictionary<MailAccountId, MailRuleEvaluationRun> runs = [];
    ...
    internal MailRuleEvaluationRun? Find(MailAccountId account) => this.runs.GetValueOrDefault(account);
