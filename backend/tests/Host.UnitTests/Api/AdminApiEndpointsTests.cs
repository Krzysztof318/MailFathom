    ...
    public void MapAdminApi_Always_ServesEveryRouteBeneathTheAdministrativePrefix()
    {
        ...
        Assert.Equal(
            [
                ...
                $"{AdminEndpointOptions.RoutePrefix}{MailboxExportEndpoints.ExportsRoute}",
                $"{AdminEndpointOptions.RoutePrefix}{MailboxExportEndpoints.ExportsRoute}",
                $"{AdminEndpointOptions.RoutePrefix}{MailboxExportEndpoints.MeasurementRoute}",
                $"{AdminEndpointOptions.RoutePrefix}{MailboxExportEndpoints.ExportRoute}",
                $"{AdminEndpointOptions.RoutePrefix}{MailboxExportEndpoints.ExportRoute}",
    ...
    public void MapAdminApi_Always_PublishesEachRouteUnderThePermissionItWasAllocated()
    {
        ...
        Assert.Equal(
            new[]
            {
                ...
                $"GET {prefix}{HeldBackRecordEndpoints.HeldBackRecordsRoute} -> {MailFathomPermission.AdminRead.Name}",
                ...
                $"GET {prefix}{MailboxExportEndpoints.MeasurementRoute} -> {MailFathomPermission.AdminExport.Name}",
                $"GET {prefix}{MailboxExportEndpoints.ExportsRoute} -> {MailFathomPermission.AdminExport.Name}",
                $"POST {prefix}{MailboxExportEndpoints.ExportsRoute} -> {MailFathomPermission.AdminExport.Name}",
                $"GET {prefix}{MailboxExportEndpoints.ExportRoute} -> {MailFathomPermission.AdminExport.Name}",
                $"POST {prefix}{MailboxExportEndpoints.CancellationRoute} -> {MailFathomPermission.AdminExport.Name}",
                $"DELETE {prefix}{MailboxExportEndpoints.ExportRoute} -> {MailFathomPermission.AdminExport.Name}",
                $"GET {prefix}{MailboxExportEndpoints.ArchiveRoute} -> {MailFathomPermission.AdminExport.Name}",
            }.Order(StringComparer.Ordinal),
