...
public sealed class ClientApiEndpointsTests
{
    ...
    public void MapClientApi_Always_ServesEveryRouteBeneathTheClientPrefix()
    {
        ...
        Assert.Equal(
            [
                ...
                $"{ClientEndpointOptions.RoutePrefix}{ClientContactEndpoints.ContactRoute}",
                $"{ClientEndpointOptions.RoutePrefix}{ClientContactEndpoints.ContactRoute}",
                $"{ClientEndpointOptions.RoutePrefix}{ClientContactCorrespondenceEndpoint.ContactCorrespondenceRoute}",
                $"{ClientEndpointOptions.RoutePrefix}{ClientContactEndpoints.ContactPromotionRoute}",
                $"{ClientEndpointOptions.RoutePrefix}{ClientContactRelationshipEndpoint.ContactRelationshipRoute}",
                ...
                $"{ClientEndpointOptions.RoutePrefix}{ClientMailCleanedBodyEndpoint.CleanedMailBodyRoute}",
                ...
                $"{ClientEndpointOptions.RoutePrefix}{ClientMailMutationsEndpoint.DeleteReleasesRoute}",
                $"{ClientEndpointOptions.RoutePrefix}{ClientMailMutationsEndpoint.DeleteWithdrawalsRoute}",
    ...
    public void MapClientApi_Always_PublishesEachRouteUnderThePermissionItWasAllocated()
    {
        ...
        Assert.Equal(
            [
                ...
                $"GET {prefix}{ClientContactCorrespondenceEndpoint.ContactCorrespondenceRoute} -> {MailFathomPermission.MailRead.Name}",
                $"GET {prefix}{ClientContactRelationshipEndpoint.ContactRelationshipRoute} -> {MailFathomPermission.MailAsk.Name}",
                $"GET {prefix}{ClientDiscoveryRunEndpoints.DiscoveryRunRoute} -> {MailFathomPermission.MailAsk.Name}",
                ...
                $"GET {prefix}{ClientMailCleanedBodyEndpoint.CleanedMailBodyRoute} -> {MailFathomPermission.MailAsk.Name}",
    ...
    /// chat provider, so a credential provisioned to read a mailbox cannot ask a question of it. Asking is a
    /// <c>POST</c> because the question is the most revealing value this surface carries and a request line would put it
