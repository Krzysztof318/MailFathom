...
public sealed class UserClientAssertionAuthenticatorTests
{
    ...
    [Fact]
    public async Task AuthenticateAsync_AnAssertionSignedByARegisteredKey_AdmitsTheUserThatKeyBelongsTo()
    {
        // Arrange
    ...
    [Fact]
    public async Task AuthenticateAsync_AnAssertionSignedByARegisteredRsaKey_AdmitsTheUserThatKeyBelongsTo()
    {
        // Arrange
        ...
        string? material = null)
    {
        ...
        credentials.FindAsync(
                ...
                Arg.Any<UserCredentialLookup>(),
                Arg.Any<CancellationToken>())
            .Returns(callInfo => callInfo.Arg<UserCredentialLookup>() == lookup
    ...
    {
        internal Task<UserClientAssertionAuthenticationResult> AuthenticateAsync(
            string assertion,
            string audience = ClientAssertion.McpAudience) =>
            this.AuthenticateRawAsync($"Bearer {assertion}", audience);

        internal Task<UserClientAssertionAuthenticationResult> AuthenticateRawAsync(
            string? headerValue,
            string audience = ClientAssertion.McpAudience) =>
