...
/// </remarks>
[Description("What giving up the draft did. The draft is gone from this deployment; what the state says is whether the copy in the user's own drafts folder went with it.")]
internal sealed record DeleteDraftToolResult
{
    ...
    /// <summary>Gets what became of the copies in the user's mailbox.</summary>
    [Description("What became of the copy in the user's drafts folder.")]
    ...
    /// neither separately: a discarded draft whose copy was left standing is a message the user still sees, which is
