...
/// <summary>The name one user credential is looked up by, in the single form the deployment stores and compares.</summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
public readonly record struct UserCredentialUsername
{
    ...
    private UserCredentialUsername(string value) => this.value = value;
    ...
    public static bool TryCreate(string? written, out UserCredentialUsername username)
    {
        username = default;
        ...
        username = new UserCredentialUsername(canonical);
    ...
    public static UserCredentialUsername Create(string written) =>
