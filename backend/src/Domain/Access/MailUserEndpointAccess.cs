...
/// </para>
/// </remarks>
public readonly record struct MailUserEndpointAccess(bool McpEndpoint, bool ClientEndpoint)
{
    /// <summary>Gets the access a user is recorded with: both endpoints.</summary>
    public static MailUserEndpointAccess Everywhere { get; } = new(McpEndpoint: true, ClientEndpoint: true);
}
