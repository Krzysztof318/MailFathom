...
internal static class NotificationMapping
{
    ...
    public static Notification ToNotification(NotificationEntity entity)
    {
        ...
        return Notification.Restore(
            ...
            entity.Title,
            entity.Body,
            NotificationStatement.Restore(entity.Cause, entity.Counted, entity.OutOf),
            entity.Source,
            TargetOf(entity),
    ...
    public static NotificationEntity ToEntity(Notification notification)
    {
        ...
        return new NotificationEntity
        {
            ...
            Cause = notification.Statement?.Cause,
            Counted = notification.Statement?.Counted,
            OutOf = notification.Statement?.OutOf,
