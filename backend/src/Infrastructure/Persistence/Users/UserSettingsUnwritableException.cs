...
/// <summary>Indicates that the database refused the statement a validated user-record write would have committed.</summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// The user's record is unchanged when this is raised, with two exceptions the message names where they apply: a
...
/// </para>
/// </remarks>
public sealed class UserSettingsUnwritableException : MailFathomException
{
    ...
    public UserSettingsUnwritableException(string operatorSafeMessage, Exception innerException)
        : base(operatorSafeMessage, innerException)
    {
    }

    /// <inheritdoc />
    public override MailFathomErrorCode ErrorCode => MailFathomErrorCode.UserSettingsUnwritable;
}
