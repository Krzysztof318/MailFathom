...
/// <summary>Indicates that one user's persisted record could not be read.</summary>
/// <remarks>
/// <para>
/// A user this deployment holds no record of is not this: that is an absence the reader reports as one, because a
...
/// </para>
/// <para>
/// The message is the operator's, so it names the user's identifier, the limit, or the place a correction is made,
...
/// </para>
/// </remarks>
public sealed class UserSettingsUnreadableException : MailFathomException
{
    /// <summary>Initializes a new failure naming what could not be read and what to do about it.</summary>
    /// <param name="operatorSafeMessage">A message naming the user's record and the operator's next step.</param>
    public UserSettingsUnreadableException(string operatorSafeMessage)
    ...
    public UserSettingsUnreadableException(string operatorSafeMessage, Exception innerException)
        : base(operatorSafeMessage, innerException)
    {
    }

    /// <inheritdoc />
    public override MailFathomErrorCode ErrorCode => MailFathomErrorCode.UserSettingsUnreadable;
}
