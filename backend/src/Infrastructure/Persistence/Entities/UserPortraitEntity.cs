...
/// <summary>The picture one person is drawn by: one row per user, holding the octets they supplied.</summary>
/// <remarks>
/// <para>
/// It hangs off the user row, which is what makes erasing a user take their portrait with everything else derived
...
internal sealed class UserPortraitEntity
{
    /// <summary>The user whose portrait this is, which is the key and the foreign key at once.</summary>
