...
/// <summary>How much stored mail content one user holds, kept as a figure rather than recomputed.</summary>
/// <remarks>
/// <para>
/// One row per user. It is the only figure in this schema that duplicates something derivable from the rows beneath
...
/// </para>
/// <para>
/// Unlike the spend ledger beside it, this cascades from the user record: it describes mail that user holds rather
...
internal sealed class UserStoredContentEntity
{
    ...
    /// <summary>Gets or sets the user this figure belongs to.</summary>
    public Guid UserId { get; set; }

    /// <summary>Gets or sets what that user's stored payloads hold, in bytes.</summary>
    /// <remarks>
