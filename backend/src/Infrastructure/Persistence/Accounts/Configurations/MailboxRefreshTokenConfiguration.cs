...
internal sealed class MailboxRefreshTokenConfiguration : IEntityTypeConfiguration<MailboxRefreshTokenEntity>
{
    ...
    public void Configure(EntityTypeBuilder<MailboxRefreshTokenEntity> entity)
    {
        ...
        // One token per account, keyed by the generated identifier alone: the credential belongs to the mailbox
        // rather than to whoever is assigned it, so assigning a second user adds no second token.
