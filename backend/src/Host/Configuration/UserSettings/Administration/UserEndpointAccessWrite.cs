...
/// <param name="EndpointAccess">Both switches as the record now states them, including one the write left out; the ones it stood at where the write was refused.</param>
