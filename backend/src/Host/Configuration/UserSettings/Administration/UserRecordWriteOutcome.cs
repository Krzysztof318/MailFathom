...
/// <summary>What a write to one user's record did: the version it committed, or why the record is unchanged.</summary>
/// <remarks>
/// <para>
...
internal sealed record UserRecordWriteOutcome
{
    ...
    /// both carry no code.
    /// </remarks>
    public static UserRecordWriteOutcome NothingToChange(long version, string message)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(message);
        ArgumentOutOfRangeException.ThrowIfNegative(version);

        return new UserRecordWriteOutcome(version, refusal: default, [message]);
    }

    /// <summary>Reports a write that changed nothing because it was refused.</summary>
    /// <param name="refusal">The code naming why.</param>
    /// <param name="versionInForce">The version the user's record still stands at.</param>
    ...
    public static UserRecordWriteOutcome Refused(
        ...
        IReadOnlyList<string> messages)
    {
        ...
        return new UserRecordWriteOutcome(versionInForce, refusal, messages);
    }
}
