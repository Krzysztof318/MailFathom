...
/// <summary>Creates the files the command keeps its session in, readable by their user and nobody else.</summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
internal static class UserOnlyStorage
{
    private const UnixFileMode UserOnlyFile = UnixFileMode.UserRead | UnixFileMode.UserWrite;

    private const UnixFileMode UserOnlyDirectory =
        UnixFileMode.UserRead | UnixFileMode.UserWrite | UnixFileMode.UserExecute;

    /// <summary>Creates a directory the user alone may enter.</summary>
    ...
    /// <summary>Opens a file for writing, creating it readable by its user alone.</summary>
    ...
    /// <summary>Opens a file for appending, creating it readable by its user alone when it does not exist yet.</summary>
    /// <param name="path">The file path.</param>
    /// <returns>The stream, which the caller disposes.</returns>
    /// <remarks>
