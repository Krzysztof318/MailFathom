...
/// <summary>Every credential one user's clients present.</summary>
/// <param name="User">The user the listing is about.</param>
/// <param name="Credentials">The credentials, oldest first.</param>
internal sealed record UserCredentialList(Guid User, IReadOnlyList<UserCredential> Credentials);

/// <summary>One credential a user's clients present, as the deployment reports it.</summary>
