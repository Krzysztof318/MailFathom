...
/// <remarks>The declaration arrives with every secret-bearing value replaced by the redaction marker; the address, the mail server, and the mailbox user name are printed as the account holds them.</remarks>
internal static class ShowMailAccountCommand
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        context.Console.WriteLine(account.Declaration ?? "{}");
