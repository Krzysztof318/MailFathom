...
/// <summary>Declares one more mailbox in a user's record.</summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
internal static class AddUserMailAccountCommand
{
    /// <summary>Builds the <c>user account add</c> command.</summary>
    ...
    internal static Command Create(CliContext context)
    {
        ...
        Command command = new("add", "Declare one more mailbox in a user's record.")
        {
            userOption,
            fileOption,
            endpointOption,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var answer = await deployment.AddUserMailAccountAsync(
            profile.Token,
            user,
            new UserMailAccountRequest(record.Version, declaration),
            cancellationToken);
