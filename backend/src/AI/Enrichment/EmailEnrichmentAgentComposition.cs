...
/// <summary>Composes the agent that reads one message into the marks a list row draws.</summary>
/// <remarks>
...
/// capability rather than a description of one — the message is put to the agent in the turn, so an agent that could
/// look anything up would be an agent able to reach mail beyond the message it was asked about.
/// </remarks>
internal static class EmailEnrichmentAgentComposition
{
    /// <summary>The name this agent is composed under, and the origin every mark it produces records.</summary>
    internal const string AgentName = "mailfathom-email-enrichment";
