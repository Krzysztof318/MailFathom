...
/// <summary>Every mailbox the user has and every folder in it, as one tree a screen draws without asking again.</summary>
/// <param name="SynchronizationEnabled">Whether the deployment refreshes the local copy of these accounts at all.</param>
/// <param name="Accounts">The user's accounts, ordered as the catalog orders them, empty when they own none.</param>
/// <remarks>
/// The switch is the deployment's rather than the user's, and it is answered beside the accounts for the reason every
