...
/// <param name="Source">Where the picture is, which is a <c>data:</c> URI for a part of the message itself and an absolute <c>https</c> address only where the reader asked for remote content.</param>
