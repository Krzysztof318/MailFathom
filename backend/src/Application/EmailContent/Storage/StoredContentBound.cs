...
/// <remarks>
/// A deployment bounds what its content storage may occupy in total and what any one user may occupy of that, and the
/// two refusals need different actions: one is raised by giving the instance more disk or a higher ceiling, the other
/// by raising that user's share or by leaving them to wait while everybody else's mail keeps arriving whole. Naming
...
public enum StoredContentBound
{
    ...
    /// <summary>The named user's stored content is at what they are allowed, while the deployment still has room.</summary>
    User = 1,
