...
/// <param name="UserClaimMark">What the user's level had claimed before the measurement started.</param>
/// <remarks>
...
/// </remarks>
public readonly record struct StoredContentMeasurementMark(long DeploymentClaimMark, long UserClaimMark);
