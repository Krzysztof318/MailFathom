...
public sealed class MailRuleEvaluationRunRequests
{
    ...
    /// <param name="account">The account to run the rules over, by its generated identifier together.</param>
    ...
    /// <param name="account">The account to run the scheduled rules over, by its generated identifier together.</param>
    /// <param name="cancellationToken">Cancels the write.</param>
