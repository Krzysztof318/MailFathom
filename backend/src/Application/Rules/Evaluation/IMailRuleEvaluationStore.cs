...
public interface IMailRuleEvaluationStore
{
    ...
    /// <param name="account">The account whose arrival queue is read, by its generated identifier together.</param>
    ...
    /// <param name="account">The account whose mailbox is walked, by its generated identifier together.</param>
