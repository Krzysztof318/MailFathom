...
/// user of its own, so every caller a mail-reading surface admits is acting for this one; when credentials become
/// records of their own, the user comes off the credential and this port stops being what answers for a caller. An
/// administrator's acts are the deployment's rather than one person's and carry no user either, so those resolve here
/// as well.
/// </para>
/// <para>
...
/// </para>
/// </remarks>
public interface IDeploymentMailUserSource
{
