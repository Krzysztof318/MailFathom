...
/// </para>
/// </remarks>
public sealed class DeploymentUserUnresolvedException : MailFathomException
{
    private DeploymentUserUnresolvedException(string operatorSafeMessage)
        : base(operatorSafeMessage)
    {
    }

    /// <inheritdoc />
    public override MailFathomErrorCode ErrorCode => MailFathomErrorCode.DeploymentUserUnresolved;
    ...
    public static DeploymentUserUnresolvedException TooManyUsers(int maximumUsers)
    {
    ...
    /// </remarks>
    public static DeploymentUserUnresolvedException SeveralUsersOnAUserFacingSurface(string refusal)
    {
    ...
    /// </remarks>
    public static DeploymentUserUnresolvedException NoUserToActFor() => new(
    ...
    /// </remarks>
    public static DeploymentUserUnresolvedException NoSoleUserToActFor() => new(
