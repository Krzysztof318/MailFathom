...
/// <remarks>
/// <para>
/// It is a port for the reason <see cref="IMailUserLanguages" /> is one, and it is answered the same way: the value
...
/// </para>
/// <para>
/// A user this deployment does not serve is answered with <see cref="MailUserTimeZone.Coordinated" /> rather than with
...
/// </para>
/// </remarks>
public interface IMailUserTimeZones
{
    ...
    MailUserTimeZone ZoneOf(MailUserId user);
    ...
    /// </remarks>
    MailUserTimeZone? StatedZoneOf(MailUserId user);
}
