...
public sealed class MailReplyDrafting
{
    ...
    /// <param name="languages">Answers which language this deployment writes for a person in, which is the language a draft answering no correspondence comes out in.</param>
