...
/// <summary>What semantic retrieval could do for one query, and the rankings it produced when it could.</summary>
/// <param name="Capability">What semantic retrieval can do, read after this query rather than before it.</param>
/// <param name="Rankings">The two orderings, each nearest first, or <see langword="null" /> when this query was not ranked semantically.</param>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// <see langword="null" /> rankings and empty ones are different answers. Null says this query was not ranked
...
public sealed record SemanticEmailSearchOutcome(
    ...
    SemanticEmailRankings? Rankings);
