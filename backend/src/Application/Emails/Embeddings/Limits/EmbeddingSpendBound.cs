...
/// <remarks>
/// A deployment bounds what it will spend in total and what any one user may spend of that, and the two refusals need
/// different actions: one is raised by raising the deployment's ceiling or waiting, the other by raising that user's
...
public enum EmbeddingSpendBound
{
    ...
    /// <summary>The named user has spent what one period admits for them, while the deployment still has room.</summary>
    User = 1,
