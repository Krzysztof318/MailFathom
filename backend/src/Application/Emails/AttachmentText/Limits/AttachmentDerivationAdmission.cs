...
/// <summary>Where one owner stands on one step of attachment reading, against both ceilings that bound them.</summary>
/// <param name="Owner">What the named owner has consumed in this period and what their own ceiling admits.</param>
/// <param name="Deployment">What every owner together has consumed and what the deployment's ceiling admits.</param>
/// <remarks>
...
public sealed record AttachmentDerivationAdmission(
    AttachmentDerivationPeriod Owner,
    AttachmentDerivationPeriod Deployment)
{
    ...
    public AttachmentDerivationBound ReachedBound => this.Deployment.IsExhausted
        ...
        : this.Owner.IsExhausted
            ? AttachmentDerivationBound.Owner
            : AttachmentDerivationBound.None;

    /// <summary>Gets whether this owner's mail may be read under this step right now.</summary>
