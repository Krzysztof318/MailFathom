...
/// <param name="AccountId">The account whose mail the message is, which decides whose authentication statements are believed.</param>
...
/// personal data by default. Nothing in this record may be written to a log; only counts, the account, and the
/// verdict's own outcome are safe to report.
/// </remarks>
