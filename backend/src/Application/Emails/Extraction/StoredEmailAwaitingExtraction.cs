...
/// <param name="Account">The mailbox the message belongs to, whose posture decides what is redacted out of its body.</param>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// The account travels with it for the reason the walk is one walk over every mailbox's mail: two rows in one batch
/// can belong to mailboxes with different scanning postures, so the answer has to be a property of the row rather
/// than of the pass.
/// </para>
/// </remarks>
