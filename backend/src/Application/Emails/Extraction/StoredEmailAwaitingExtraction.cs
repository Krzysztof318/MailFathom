...
/// <param name="User">The user the message belongs to, whose posture decides what is redacted out of its body.</param>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// The user travels with it for the reason the walk is one walk over everybody's mail: two rows in one batch can
