...
/// <param name="AccountId">The account the message belongs to, whose authentication statements the re-reading believes.</param>
/// <remarks>
...
/// </remarks>
public sealed record StoredMailAwaitingRederivation(StoredEmailId StoredEmailId, MailAccountId AccountId);
