...
/// order: the account a caller named is resolved against the accounts the caller's user is assigned, the people named become
    ...
    AccessAuthorization authorization)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var attachments = await drafts.ReadStagedAttachmentsAsync(
            account.Id,
            accountCatalog.User,
            request.Revises,
            cancellationToken);
