...
/// <remarks>
/// <para>
/// One read and one write, each for one user, so there is no shape here that touches two people's preferences and no
...
public interface IClientPreferencesStore
{
    ...
    /// <param name="user">The user whose preferences are read.</param>
