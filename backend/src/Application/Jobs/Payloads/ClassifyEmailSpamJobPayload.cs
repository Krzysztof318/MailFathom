...
/// <remarks>
/// <para>
/// Every property is one of MailFathom's own identifiers: the four that are the stable remote occurrence
/// identity — account, folder binding, UIDVALIDITY, and UID. A handler therefore
