...
/// <summary>The user's accounts and how current each one's local copy is, as a reader that draws no mail sees them.</summary>
...
/// <remarks>
/// The switch is the deployment's rather than the user's, and it is answered beside the accounts for the reason
