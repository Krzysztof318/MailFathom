...
|---|---|---|---|---|
| .NET runtime, ASP.NET Core, Microsoft.Extensions libraries, EF Core 10.0.10 design package, JWT bearer 10.0.10, Data Protection, JSON console logging | Runtime, host, framework, authentication middleware, configuration, and persistence APIs | MIT for the .NET platform packages in the dotnet repositories and NuGet package metadata | Allowed. Permissive license supports commercial closed-source use and open-source distribution with notices. | <https://github.com/dotnet/runtime>, <https://github.com/dotnet/aspnetcore>, <https://github.com/dotnet/efcore>, <https://www.nuget.org/packages/Microsoft.Extensions.AI/> |
...
| Semantic Kernel repository configuration files | Source for adapted editor and build configuration settings | MIT in upstream repository | Allowed. Adapted settings are copied without product-specific branding or comments; preserve notices in distribution materials if required. | <https://github.com/microsoft/semantic-kernel> |
| Aspire.Hosting.AppHost 13.4.6 and Aspire.Hosting.PostgreSQL 13.4.6 | Development-time local orchestration for MailMcp and PostgreSQL | MIT in NuGet package metadata and upstream repository | Allowed as development tooling/orchestration packages. Preserve required notices if distributed. | <https://www.nuget.org/packages/Aspire.Hosting.AppHost/13.4.6>, <https://www.nuget.org/packages/Aspire.Hosting.PostgreSQL/13.4.6>, <https://github.com/dotnet/aspire> |
