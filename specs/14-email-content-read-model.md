...
**Selected: `HtmlSanitizer`.** MIT, actively maintained, and the de facto standard for this job in .NET. It parses with AngleSharp rather than regular expressions, and its model is an allow-list of tags, attributes, CSS properties, and URI schemes, which is the shape this specification requires.
