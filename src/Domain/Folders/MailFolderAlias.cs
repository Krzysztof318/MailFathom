...
/// <summary>Names a mailbox folder the way MailMcp and its operator refer to it.</summary>
/// <remarks>
/// The alias is owned by MailMcp rather than by the mail server: it appears in configuration, in logs, and in future
...
public readonly record struct MailFolderAlias
{
    ...
    /// or queried — including in a database whose collation MailMcp does not control. Upper case is the canonical
