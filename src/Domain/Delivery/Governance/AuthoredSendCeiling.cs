...
/// <remarks>
/// The two are kept apart for the reason the deployment's four are: a caller sending one message to two hundred people
/// and a caller sending two hundred messages are different faults, and an operator reading which one was reached learns
/// which of the two numbers they wrote is the one doing the work.
/// </remarks>
