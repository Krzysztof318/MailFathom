...
/// <summary>Contains raw MIME content fetched through a seen-preserving IMAP operation.</summary>
...
public sealed record RemoteMessageContent(MessageOccurrenceId OccurrenceId, IReadOnlyList<byte> RawMime);
