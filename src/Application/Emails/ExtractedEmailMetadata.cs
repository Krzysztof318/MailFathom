...
/// <remarks>
/// Participants, subject, and thread identifiers are personal data by default. Nothing in this record may be written to
/// a log; only counts and the occurrence identity are safe to report.
/// </remarks>
