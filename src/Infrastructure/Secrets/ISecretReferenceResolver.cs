...
/// give every use case the ability to ask for any secret by name, which is the broad secret access ADR 0002 forbids
/// normalizing into application code. Application code receives only the narrowly scoped settings each operation needs.
/// </para>
/// <para>
