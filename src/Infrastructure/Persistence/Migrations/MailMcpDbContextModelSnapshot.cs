...
namespace MailMcp.Infrastructure.Persistence.Migrations
{
    ...
    partial class MailMcpDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MailMcp.Infrastructure.Persistence.EmailSearchDocumentEntity", b =>
                {
                    b.Property<Guid>("StoredEmailId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MailMcp.Infrastructure.Persistence.MailFolderEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MailMcp.Infrastructure.Persistence.MailboxAccountEntity", b =>
                {
            ...
            modelBuilder.Entity("MailMcp.Infrastructure.Persistence.SynchronizationCheckpointEntity", b =>
                {
                    b.Property<long>("MailFolderId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MailMcp.Infrastructure.Persistence.EmailMessageContentEntity", b =>
                {
                    b.HasOne("MailMcp.Infrastructure.Persistence.StoredEmailEntity", "StoredEmail")
                        .WithOne("Content")
                        .HasForeignKey("MailMcp.Infrastructure.Persistence.EmailMessageContentEntity", "StoredEmailId")
            ...
            modelBuilder.Entity("MailMcp.Infrastructure.Persistence.EmailSearchDocumentEntity", b =>
                {
                    b.HasOne("MailMcp.Infrastructure.Persistence.StoredEmailEntity", "StoredEmail")
                        ...
                        .HasForeignKey("MailMcp.Infrastructure.Persistence.EmailSearchDocumentEntity", "StoredEmailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MailMcp.Infrastructure.Persistence.MailFolderEntity", b =>
                {
                    b.HasOne("MailMcp.Infrastructure.Persistence.MailboxAccountEntity", "MailboxAccount")
            ...
            modelBuilder.Entity("MailMcp.Infrastructure.Persistence.StoredEmailEntity", b =>
                {
                    b.HasOne("MailMcp.Infrastructure.Persistence.MailFolderEntity", "MailFolder")
            ...
            modelBuilder.Entity("MailMcp.Infrastructure.Persistence.SynchronizationCheckpointEntity", b =>
                {
                    b.HasOne("MailMcp.Infrastructure.Persistence.MailFolderEntity", "MailFolder")
                        ...
                        .HasForeignKey("MailMcp.Infrastructure.Persistence.SynchronizationCheckpointEntity", "MailFolderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
