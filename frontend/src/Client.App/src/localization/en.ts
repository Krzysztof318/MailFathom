...
export const en = {
    ...
    'agent.closeHistory': 'Close history',
    'agent.reach': 'works across your mail, calendar and cases',
    'agent.conversations': 'Conversations with the agent',
    'agent.historyReading': 'Reading your conversations…',
    'agent.historyEmpty': 'No conversations yet. Tell the agent what to do below and one starts here.',
    'agent.historyFailed.unauthenticated': 'The session ended, so the history could not be read. Sign in again.',
    'agent.historyFailed.unauthorized': 'This account is not allowed to talk to the agent.',
    'agent.historyFailed.unavailable': 'The deployment could not be reached, so the history is not shown.',
    'agent.historyFailed.unreadable': 'The deployment answered with a history this client cannot read.',
    'agent.readAgain': 'Read again',
    'agent.selectConversations': 'Select conversations',
    'agent.openConversation': 'Open conversation',
    'agent.deleteConversation': 'Delete conversation',
    'agent.archiveConversation': 'Archive',
    'agent.restoreConversation': 'Restore from archive',
    'agent.archived': 'Archived ({count})',
    'agent.showArchived': 'Show the archived conversations',
    'agent.hideArchived': 'Hide the archived conversations',
    'agent.archivedConversations': 'Archived conversations',
    'agent.selectionBar': 'Actions on the conversations selected',
    'agent.clearSelection': 'Cancel selection',
    'agent.archive': 'Archive',
    'agent.delete': 'Delete',
    'agent.deleteOne': 'Delete this conversation?',
    'agent.deleteOneConsequence': 'Messages in “{title}” with the agent will be permanently deleted.',
    'agent.deleteManyQuestion': 'Delete conversations?',
    'agent.deleteMany.one': '{count} conversation will be permanently deleted.',
    'agent.deleteMany.few': '{count} conversations will be permanently deleted.',
    'agent.deleteMany.many': '{count} conversations will be permanently deleted.',
    'agent.deleteMany.other': '{count} conversations will be permanently deleted.',
    'agent.deletePermanent': 'This cannot be undone.',
    'agent.notDeleted.unauthenticated':
        'The session ended before the conversation was deleted. Sign in again and delete it.',
    'agent.notDeleted.unauthorized': 'This account is not allowed to delete conversations with the agent.',
    'agent.notDeleted.unavailable':
        'The deployment could not be reached, so the conversation was not deleted. Try again.',
    ...
    'agent.tabs': 'Open conversations',
    'agent.closeTab': 'Close {title}',
    'agent.thread': 'Conversation with the agent',
    'agent.answer': 'The agent’s answer',
    'agent.greeting':
        'Hi. I can write a message, lay out your day or check what is stuck. I always show the result for approval — nothing goes out without you.',
    'agent.scopeLine': '· {scope}',
    'agent.scope.mailbox': 'your mail',
    'agent.scope.thread': 'this thread',
    'agent.scope.calendarEvent': 'this event',
    'agent.scope.discoveryRun': 'this Discover answer',
    'agent.scope.stopped': 'stopped by you',
    'agent.context.thread': 'Context: thread “{title}”',
    'agent.context.calendarEvent': 'Context: event “{title}”',
    'agent.context.discoveryRun': 'Context: Discover answer “{title}”',
    'agent.clearContext': 'Remove context',
    'agent.askAgent': 'Ask the agent',
    'agent.goWithThread': 'Go to the agent — I’ll ask in my own words',
    'agent.working': 'The agent is going through your mail…',
    'agent.returnToConversation': 'Back to the conversation',
    'agent.statusFallback': 'Going through your mail',
    'agent.failed': 'The agent could not finish this answer. What arrived stays — ask again to pick it up.',
    'agent.reading': 'Reading the conversation…',
    'agent.readFailed.unauthenticated': 'The session ended, so the conversation could not be read. Sign in again.',
    'agent.readFailed.unauthorized': 'This account is not allowed to read conversations with the agent.',
    'agent.readFailed.unavailable':
        'The deployment could not be reached. The conversation is read again as soon as it answers.',
    'agent.readFailed.unreadable': 'The deployment answered with a conversation this client cannot read.',
    'agent.readFailed.missing':
    ...
    'agent.composerLabel': 'Tell the agent what to do',
    'agent.composerPlaceholder': 'Tell me what to do — write, schedule, check',
    'agent.sendKey': '⏎',
    'agent.send': 'Send',
    'agent.cancel': 'Cancel',
    'agent.cancelRunning': 'Stop what the agent is doing',
    'agent.cancelIdle': 'Cancel — nothing is running',
    'agent.footer': 'The agent proposes actions — nothing is sent without your approval.',
    'agent.notSent.unauthenticated': 'The session ended before this was sent. Sign in again and send it.',
    'agent.notSent.unauthorized': 'This account is not allowed to talk to the agent.',
    'agent.notSent.unavailable':
        'This was not sent — the deployment could not be reached, or the answer it was meant for has just ended. Send it again.',
    'agent.notSent.unreadable':
        'The deployment accepted this in a way this client cannot read. Open the conversation from the history to see whether it arrived.',
    'agent.notSent.missing': 'This conversation is no longer there, so nothing was sent. Start a new one.',
    'discover.newQuestion': 'New question',
    'discover.continueWithAgent': 'Continue with the agent',
    'discover.handToAgentPrompt': 'Want to dig deeper, or have something done with this?',
    'discover.handToAgent': 'Hand to the agent',
    ...
    'suggestedAction.take': 'Do it',
    'suggestedAction.takeName': 'Do it: {title}',
    'suggestedAction.declineName': 'Decline: {title}',
    'suggestedAction.done': 'Done',
    'suggestedAction.failed': 'Could not do it.',
    'suggestedAction.empty': 'Nothing worth doing here — the thread needs no step.',
    'suggestedAction.error': 'Could not build this proposal. The model timed out.',
    'draft.send': 'Send',
    'draft.sendName': 'Send the draft to {to}',
    'draft.sendEditedName': 'Send the edited draft to {to}',
    'draft.editHere': 'Edit here',
    'draft.editHereName': 'Edit here — the draft to {to}, inside the conversation',
    'draft.discard': 'Discard',
    'draft.discardName': 'Discard the draft to {to}',
    'draft.stopEditingName': 'Stop editing the draft to {to}',
    'draft.editedUnsendable':
        'Your edit cannot be sent from here yet — only the draft as it was proposed can. Put the text back to send it, or copy your changes into a reply.',
    'draft.done': 'Sent',
    'draft.failed': 'Could not send it.',
    'draft.empty': 'Nothing to draft — the last message in the thread is yours.',
    'draft.error': 'Could not build this proposal. The model timed out.',
    'eventProposal.label': 'Event proposal',
    'eventProposal.when': 'When',
    'eventProposal.duration': 'Duration',
    'eventProposal.from': 'From thread',
    'eventProposal.add': 'Add to calendar',
    'eventProposal.addName': 'Add to calendar: “{title}”, {when}',
    'eventProposal.anotherTime': 'Another time',
    'eventProposal.anotherTimeName': 'Ask for another time for “{title}”',
    'eventProposal.anotherTimeLine': 'Find another time for “{title}”',
    'eventProposal.declineName': 'Decline putting “{title}” in the calendar',
    'eventProposal.done': 'Added to the calendar',
    'eventProposal.failed': 'Could not add it to the calendar.',
    'eventProposal.empty': 'No free slot long enough this week — nothing to propose.',
    'eventProposal.error': 'Could not build this proposal. The calendar did not answer.',
    'taskProposal.label': 'Task proposal',
    'taskProposal.due': 'Due',
    'taskProposal.from': 'From message',
    'taskProposal.add': 'Add',
    'taskProposal.addName': 'Add the task “{title}”, due {due}',
    'taskProposal.addNameUndated': 'Add the task “{title}”',
    'taskProposal.declineName': 'Decline the task “{title}”',
    'taskProposal.done': 'Added to tasks',
    'taskProposal.failed': 'Could not add the task.',
    'taskProposal.empty': 'Nothing in this thread carries a date or an owner.',
    'taskProposal.error': 'Could not build this proposal. The task list did not answer.',
    'proposal.needsConfirmation': 'needs confirmation',
    'proposal.done': 'done',
    'proposal.notDone': 'not done',
    'proposal.declined': 'declined',
    'proposal.declinedLine': 'Declined — nothing was done',
    'proposal.decline': 'Decline',
    'proposal.tryAgain': 'Try again',
    'proposal.tryAgainName': 'Try again: {title}',
    'proposal.retryName': 'Try again: {block}',
    'proposal.openCalendar': 'Open the calendar',
    'proposal.openThread': 'Open the thread',
    'proposal.lookName': '{look} — leaves the conversation, you can come straight back',
    'proposal.refused.unauthenticated':
        'The session ended before this was answered. Sign in again and answer it again.',
    'proposal.refused.unauthorized': 'This account is not allowed to answer what the agent proposes.',
    'proposal.refused.unavailable': 'The server did not answer, so nothing was done. Try again when it is back.',
    'proposal.refused.unreadable':
        'The server’s answer could not be read, so what became of this is not known here. Report it as a defect.',
    'proposal.refused.missing': 'This proposal was already answered, or it is no longer there.',
