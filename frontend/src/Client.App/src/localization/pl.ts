...
export const pl: Catalogue = {
    ...
    'settings.systemNotifications': 'Powiadomienia',
    ...
    'compose.refusedAttachmentNotRead':
        'Jednego z załączonych plików nie dało się odczytać, więc nic nie sprawdziło tego, co miało z nim wyjść, i wiadomość nie została wysłana. Wysłanie bez tego pliku albo załączenie go w postaci, którą da się odczytać, jest tym, co to zmieni.',
    ...
    'pendingChange.waiting.one': 'Jedna zmiana nie dotarła jeszcze do Twojej skrzynki.',
    'pendingChange.waiting.few': '{count} zmiany nie dotarły jeszcze do Twojej skrzynki.',
    'pendingChange.waiting.many': '{count} zmian nie dotarło jeszcze do Twojej skrzynki.',
    'pendingChange.waiting.other': '{count} zmian nie dotarło jeszcze do Twojej skrzynki.',
    'pendingChange.markRead': 'Oznaczenie jako przeczytane',
    'pendingChange.undecided': 'Zmiana czeka na Twoją decyzję.',
    'pendingChange.exhausted': 'Twoja skrzynka nie przyjęła tej zmiany, a MailFathom przestał próbować ją wprowadzić.',
    'pendingChange.unanswered':
        'Zmiana została wysłana, a skrzynka nigdy nie odpowiedziała — mogła zostać wprowadzona albo nie.',
    'pendingChange.askAgain': 'Poproś ponownie',
    'pendingChange.letGo': 'Odpuść',
    'pendingChange.notMarkedRead.one': 'Jedna wiadomość nie została oznaczona jako przeczytana.',
    'pendingChange.notMarkedRead.few': '{count} wiadomości nie zostały oznaczone jako przeczytane.',
    'pendingChange.notMarkedRead.many': '{count} wiadomości nie zostało oznaczonych jako przeczytane.',
    'pendingChange.notMarkedRead.other': '{count} wiadomości nie zostało oznaczonych jako przeczytane.',
    'pendingChange.messageNotFound': 'Tej poczty nie ma już w skrzynce, którą czyta to wdrożenie.',
    ...
    'notifications.unread.other': '{count} nieprzeczytanych powiadomień',
    'notifications.new.one': '{count} nowe',
    'notifications.new.few': '{count} nowe',
    'notifications.new.many': '{count} nowych',
    'notifications.new.other': '{count} nowych',
    'notifications.close': 'Zamknij powiadomienia',
    'notifications.filter': 'Co pokazuje lista',
    ...
    'notifications.select': 'Zaznacz powiadomienia',
    'notifications.openSource': 'Otwórz źródło',
    'notifications.selectionBar': 'Działania na zaznaczonych powiadomieniach',
    'notifications.empty': 'Nic nowego. Wszystko przeczytane.',
    'notifications.reading': 'Odczytujemy, co się wydarzyło…',
    'notifications.failed': 'Nie udało się odczytać powiadomień: {reason}.',
    'notifications.show': 'Pokaż',
    'notifications.readStateNotChanged': 'Nie udało się oznaczyć tego powiadomienia. Zostaje tak, jak było.',
    'notifications.notAllMarkedRead': 'Nie udało się oznaczyć powiadomień jako przeczytanych. Zostają tak, jak były.',
    'notifications.arrived.mail.one': '{count} nowa wiadomość',
    'notifications.arrived.mail.few': '{count} nowe wiadomości',
    'notifications.arrived.mail.many': '{count} nowych wiadomości',
    'notifications.arrived.mail.other': '{count} nowej wiadomości',
    'notifications.arrived.calendar.one': '{count} przypomnienie z kalendarza',
    'notifications.arrived.calendar.few': '{count} przypomnienia z kalendarza',
    'notifications.arrived.calendar.many': '{count} przypomnień z kalendarza',
    'notifications.arrived.calendar.other': '{count} przypomnienia z kalendarza',
    'notifications.arrived.case.one': '{count} zmiana w sprawie',
    'notifications.arrived.case.few': '{count} zmiany w sprawach',
    'notifications.arrived.case.many': '{count} zmian w sprawach',
    'notifications.arrived.case.other': '{count} zmiany w sprawach',
    'notifications.arrived.task.one': '{count} przypomnienie o zadaniu',
    'notifications.arrived.task.few': '{count} przypomnienia o zadaniach',
    'notifications.arrived.task.many': '{count} przypomnień o zadaniach',
    'notifications.arrived.task.other': '{count} przypomnienia o zadaniach',
    'notifications.arrived.system.one': '{count} komunikat od MailFathom',
    'notifications.arrived.system.few': '{count} komunikaty od MailFathom',
    'notifications.arrived.system.many': '{count} komunikatów od MailFathom',
    'notifications.arrived.system.other': '{count} komunikatu od MailFathom',
    'notifications.kind.mail': 'Poczta',
    'notifications.kind.calendar': 'Kalendarz',
    'notifications.kind.case': 'Sprawy',
    'notifications.kind.task': 'Zadania',
