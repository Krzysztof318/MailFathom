...
export const pl: Catalogue = {
    ...
    'ai.badge': 'AI',
    'agent.history': 'Historia',
    'agent.new': 'Nowa',
    'agent.newConversation': 'Nowa rozmowa',
    'agent.closeHistory': 'Zamknij historię',
    'agent.reach': 'działa w poczcie, kalendarzu i sprawach',
    'agent.conversations': 'Rozmowy z agentem',
    'agent.historyReading': 'Wczytuję rozmowy…',
    'agent.historyEmpty': 'Nie ma jeszcze rozmów. Napisz agentowi poniżej, co ma zrobić, a rozmowa pojawi się tutaj.',
    'agent.historyFailed.unauthenticated': 'Sesja wygasła, więc nie udało się wczytać historii. Zaloguj się ponownie.',
    'agent.historyFailed.unauthorized': 'To konto nie ma uprawnień do rozmowy z agentem.',
    'agent.historyFailed.unavailable': 'Nie udało się połączyć z wdrożeniem, więc historia nie jest wyświetlana.',
    'agent.historyFailed.unreadable': 'Wdrożenie odpowiedziało historią, której ten klient nie potrafi odczytać.',
    'agent.readAgain': 'Wczytaj ponownie',
    ...
    'agent.deleteManyQuestion': 'Usunąć rozmowy?',
    'agent.deleteMany.one': '{count} rozmowa zostanie trwale usunięta.',
    'agent.deleteMany.few': '{count} rozmowy zostaną trwale usunięte.',
    'agent.deleteMany.many': '{count} rozmów zostanie trwale usuniętych.',
    'agent.deleteMany.other': 'Rozmowy do trwałego usunięcia: {count}.',
    'agent.deletePermanent': 'Tego nie da się cofnąć.',
    'agent.notDeleted.unauthenticated': 'Sesja wygasła przed usunięciem rozmowy. Zaloguj się ponownie i usuń ją.',
    'agent.notDeleted.unauthorized': 'To konto nie ma uprawnień do usuwania rozmów z agentem.',
    'agent.notDeleted.unavailable':
    ...
    'agent.answer': 'Odpowiedź agenta',
    'agent.greeting':
        'Cześć. Mogę napisać wiadomość, rozplanować Twój dzień albo sprawdzić, co utknęło. Wynik zawsze pokazuję do akceptacji — nic nie wychodzi bez Ciebie.',
    'agent.scopeLine': '· {scope}',
    'agent.scope.mailbox': 'Twoja poczta',
    'agent.scope.thread': 'ten wątek',
    'agent.scope.calendarEvent': 'to wydarzenie',
    'agent.scope.discoveryRun': 'ta odpowiedź z Odkrywania',
    'agent.scope.stopped': 'zatrzymane przez Ciebie',
    'agent.context.thread': 'Kontekst: wątek „{title}”',
    'agent.context.calendarEvent': 'Kontekst: wydarzenie „{title}”',
    'agent.context.discoveryRun': 'Kontekst: odpowiedź z Odkrywania „{title}”',
    'agent.clearContext': 'Usuń kontekst',
    'agent.askAgent': 'Zapytaj agenta',
    'agent.goWithThread': 'Przejdź do agenta — zapytam własnymi słowami',
    'agent.working': 'Agent przegląda Twoją pocztę…',
    'agent.returnToConversation': 'Wróć do rozmowy',
    'agent.statusFallback': 'Przeglądam Twoją pocztę',
    'agent.failed':
        'Agent nie zdołał dokończyć tej odpowiedzi. To, co dotarło, zostaje — zapytaj ponownie, aby kontynuować.',
    'agent.reading': 'Wczytuję rozmowę…',
    'agent.readFailed.unauthenticated': 'Sesja wygasła, więc nie udało się wczytać rozmowy. Zaloguj się ponownie.',
    'agent.readFailed.unauthorized': 'To konto nie ma uprawnień do czytania rozmów z agentem.',
    'agent.readFailed.unavailable':
        'Nie udało się połączyć z wdrożeniem. Rozmowa zostanie wczytana ponownie, gdy tylko odpowie.',
    'agent.readFailed.unreadable': 'Wdrożenie odpowiedziało rozmową, której ten klient nie potrafi odczytać.',
    ...
    'agent.composerLabel': 'Powiedz agentowi, co ma zrobić',
    'agent.composerPlaceholder': 'Powiedz, co mam zrobić — napisać, zaplanować, sprawdzić',
    'agent.sendKey': '⏎',
    'agent.send': 'Wyślij',
    'agent.cancel': 'Anuluj',
    'agent.cancelRunning': 'Zatrzymaj to, co robi agent',
    'agent.cancelIdle': 'Anuluj — nic nie jest w toku',
    'agent.footer': 'Agent proponuje działania — nic nie zostanie wysłane bez Twojej zgody.',
    'agent.notSent.unauthenticated': 'Sesja wygasła przed wysłaniem. Zaloguj się ponownie i wyślij to jeszcze raz.',
    'agent.notSent.unauthorized': 'To konto nie ma uprawnień do rozmowy z agentem.',
    'agent.notSent.unavailable':
        'Nie wysłano — nie udało się połączyć z wdrożeniem albo odpowiedź, do której to było, właśnie się zakończyła. Wyślij ponownie.',
    'agent.notSent.unreadable':
        'Wdrożenie przyjęło to w sposób, którego ten klient nie potrafi odczytać. Otwórz rozmowę z historii, aby sprawdzić, czy dotarło.',
    'agent.notSent.missing': 'Tej rozmowy już nie ma, więc nic nie zostało wysłane. Zacznij nową.',
    'discover.newQuestion': 'Nowe pytanie',
    'discover.continueWithAgent': 'Kontynuuj z agentem',
    'discover.handToAgentPrompt': 'Chcesz drążyć dalej albo coś z tym zrobić?',
    'discover.handToAgent': 'Przekaż agentowi',
    ...
    'answer.supported': 'potwierdzone',
    'answer.supportedNote': 'Korespondencja to potwierdza — ze źródeł aktualnych w chwili odczytu.',
    'answer.unsupported': 'niepotwierdzone',
    'answer.unsupportedNote':
        'Nic, co znalazło to uruchomienie, tego nie potwierdza — potraktuj to jako odczyt, nie jako fakt.',
    'answer.outdated': 'nieaktualne',
    'answer.outdatedNote':
        'To jest potwierdzone, ale lokalna kopia źródła jest znana jako zaległa wobec serwera poczty.',
    'answer.conflicting': 'sprzeczne z innym źródłem',
    'answer.conflictingNote':
        'Źródła są ze sobą sprzeczne. Obie strony są poniżej, każda ze źródłami, które tak mówią.',
    'answer.sides': 'Strony sprzeczności',
    'answer.citationCount.one': '{count} cytowanie',
    'answer.citationCount.few': '{count} cytowania',
    'answer.citationCount.many': '{count} cytowań',
    'answer.citationCount.other': '{count} cytowania',
    'answer.citation': 'Cytowanie {position}: {source}',
    'answer.citationUndeclared': 'Cytowanie {position} — ten klient nie otrzymał źródła, które za nim stoi',
    'answer.citationUnfollowable':
        'Cytowanie {position}: {source} — ten klient nie potrafi otworzyć wskazanego miejsca',
    'answer.evidenceCount.one': '{count} pozycja · wg trafności',
    'answer.evidenceCount.few': '{count} pozycje · wg trafności',
    'answer.evidenceCount.many': '{count} pozycji · wg trafności',
    'answer.evidenceCount.other': '{count} pozycji · wg trafności',
    'answer.evidenceEmpty': 'Żaden dokument nie przekroczył progu trafności dla tego zapytania.',
    'answer.evidenceItem': 'Dowód: {source} — trafność {relevance}, {freshness}',
    'answer.relevance': 'trafność {share}',
    'answer.freshnessCurrent': 'aktualne · {at}',
    'answer.freshnessStale': 'zaległe · {at}',
    'answer.freshnessUnknown': 'aktualność nieustalona',
    'answer.sourceMessage': 'wiadomość',
    'answer.sourceAttachment': 'załącznik',
    'answer.sourceDepicted': 'opis obrazu',
    'answer.sourcePrivate': 'źródło prywatne',
    'answer.sourcePrivateName': 'Źródło prywatne',
    'answer.sourcePrivateBody': 'Treść niedostępna do wglądu — wniosek wyciągnięty z tego źródła pozostaje w wyniku.',
    'answer.timelineLabel': 'Oś czasu',
    'answer.timelineCount.one': '{count} zdarzenie',
    'answer.timelineCount.few': '{count} zdarzenia',
    'answer.timelineCount.many': '{count} zdarzeń',
    'answer.timelineCount.other': '{count} zdarzenia',
    'answer.timelineEmpty': 'Brak zdarzeń w okresie, którego dotyczy to pytanie.',
    'answer.timelineUndated': 'data nieczytelna',
    'answer.factTableLabel': 'Zestawienie faktów',
    'answer.factTableCaption': 'Wartości zestawione w kolumnach, które znalazła ta odpowiedź',
    'answer.factTableCount.one': '{count} wiersz',
    'answer.factTableCount.few': '{count} wiersze',
    'answer.factTableCount.many': '{count} wierszy',
    'answer.factTableCount.other': '{count} wiersza',
    'answer.factTableEmpty': 'Żadna kolumna nie miała pokrycia w źródłach — tabela pozostaje pusta.',
    'answer.factCellUnstated': 'nie podano',
    'answer.columnSubject': 'Czego dotyczy',
    'answer.columnParty': 'Strona',
    'answer.columnDocument': 'Dokument',
    'answer.columnReference': 'Oznaczenie',
    'answer.columnAmount': 'Kwota',
    'answer.columnQuantity': 'Ilość',
    'answer.columnTerm': 'Warunek',
    'answer.columnVersion': 'Wersja',
    'answer.columnStatus': 'Status',
    'answer.columnDate': 'Data',
    'answer.galleryLabel': 'Załączniki',
    'answer.galleryCount.one': '{count} plik',
    'answer.galleryCount.few': '{count} pliki',
    'answer.galleryCount.many': '{count} plików',
    'answer.galleryCount.other': '{count} pliku',
    'answer.galleryEmpty': 'Wiadomości w tym zakresie nie miały załączników.',
    'answer.galleryFrom': '{size} · z {message}',
    'answer.galleryItem': 'Załącznik: {name}, {size}, {availability} — z {message}',
    'answer.attachmentStored': 'dostępny',
    'answer.attachmentNotStored': 'niezapisany',
    'answer.attachmentRemoved': 'usunięty',
    'evidence.panel': 'Dowody',
    'evidence.resting': 'Naciśnij cytowanie, aby zobaczyć fragment, na którym się opiera.',
    'evidence.dismiss': 'Wróć do odpowiedzi',
    'evidence.following': 'Otwieranie źródła…',
    'evidence.standingIn': '{account} · {folder}',
    'evidence.openInMail': 'Otwórz w poczcie',
    'evidence.wholeMessage': 'To opiera się na całej wiadomości, a nie na jednym jej fragmencie.',
    'evidence.unresolvable':
        'Fragment, na którym się to opiera, został podzielony na nowo od czasu złożenia odpowiedzi, więc nie można go pokazać. Wiadomość, z której pochodzi, jest powyżej.',
    'evidence.unreadableCopy':
        'To wdrożenie nie odczytało własnej kopii wiadomości stojącej za tym źródłem. Fakt opiera się na tym, co odczytano przy składaniu odpowiedzi.',
    'evidence.privateRemedy': 'Poproś administratora tego wdrożenia o dostęp do konta, z którego je odczytano.',
    'evidence.unfollowable': 'Ta odpowiedź wskazuje źródło rodzaju, którego ten klient nie potrafi otworzyć.',
    'evidence.unauthenticated':
        'Sesja zakończyła się w trakcie otwierania tego źródła. Zaloguj się ponownie, aby je zobaczyć.',
    'evidence.unauthorized': 'To konto nie ma prawa czytać tego źródła.',
    'evidence.unavailable': 'Brak połączenia z serwerem — nie można otworzyć tego źródła.',
    'evidence.unreadable': 'Źródło dotarło w postaci, której ten klient nie odczytał; to usterka warta zgłoszenia.',
    'evidence.missing': 'To wdrożenie nie przechowuje już wiadomości stojącej za tym źródłem.',
    'answer.peopleLabel': 'Osoby',
    'answer.peopleCount.one': '{count} osoba · rola odczytana z korespondencji',
    'answer.peopleCount.few': '{count} osoby · role odczytane z korespondencji',
    'answer.peopleCount.many': '{count} osób · role odczytane z korespondencji',
    'answer.peopleCount.other': '{count} osób · role odczytane z korespondencji',
    'answer.peopleLastContact': 'ostatni kontakt {at}',
    'answer.peopleLastContactNone': 'kontaktu nie ustalono',
    'answer.peopleLastContactUnreadable': 'data ostatniego kontaktu nieczytelna',
    'answer.peopleEmpty': 'Nie udało się powiązać żadnych osób z tym pytaniem.',
    'threadStanding.label': 'Stan wątku',
    'threadStanding.participants': 'Uczestnicy',
    'threadStanding.participantCount.one': '{count} uczestnik',
    'threadStanding.participantCount.few': '{count} uczestnicy',
    'threadStanding.participantCount.many': '{count} uczestników',
    'threadStanding.participantCount.other': '{count} uczestników',
    'threadStanding.agreed': 'Ustalone',
    'threadStanding.openQuestions': 'Pytania otwarte',
    'threadStanding.commitments': 'Zobowiązania',
    'threadStanding.noAgreements': 'Nic jeszcze nie zostało ustalone.',
    'threadStanding.noOpenQuestions': 'Nic nie pozostaje otwarte.',
    'threadStanding.noCommitments': 'Nikt się do niczego nie zobowiązał.',
    'threadStanding.commitment': '{what}',
    'threadStanding.commitmentDue': '{what} · termin {when}',
    'threadStanding.commitmentOwedBy': '{name} — {what}',
    'threadStanding.commitmentOwedByDue': '{name} — {what} · termin {when}',
    'threadStanding.commitmentDueUnreadable': '{what} · data terminu nieczytelna',
    'threadStanding.commitmentOwedByDueUnreadable': '{name} — {what} · data terminu nieczytelna',
    'threadStanding.empty': 'Ta rozmowa nie zawiera jeszcze ustaleń, pytań otwartych ani zobowiązań.',
    'draft.label': 'Szkic',
    'draft.composed': 'Szkic lokalny — nic nie zostało wysłane',
    ...
    'draft.stopEditing': 'Zakończ edycję',
    'draft.editKept': 'Zmiany zostają na tym ekranie — nic tutaj nie zapisuje ani nie wysyła szkicu.',
    'suggestedAction.label': 'Proponowane działanie',
    'suggestedAction.replyToThread': 'Odpowiedz w tej rozmowie',
    'suggestedAction.forwardEmail': 'Przekaż wiadomość komuś innemu',
    'suggestedAction.composeEmail': 'Napisz do osoby wskazanej w tej odpowiedzi',
    'suggestedAction.flagEmail': 'Oznacz wiadomość, aby do niej wrócić',
    'suggestedAction.openThread': 'Przeczytaj całą rozmowę',
    'suggestedAction.searchAgain': 'Poszukaj ponownie z tym, co udało się ustalić',
    'suggestedAction.createMailRule': 'Utwórz regułę, która sama posegreguje taką pocztę',
    'suggestedAction.readsOnly': 'nic się nie zmienia — tylko coś Ci pokaże',
    'suggestedAction.changesMailbox': 'coś zmieni się w Twojej skrzynce i możesz to cofnąć',
    'suggestedAction.sendsMail': 'poczta opuści to wdrożenie, czego nic tutaj nie odwróci',
    'suggestedAction.take': 'Zrób to',
    'suggestedAction.takeName': 'Zrób to: {title}',
    'suggestedAction.declineName': 'Odrzuć: {title}',
    'suggestedAction.done': 'Zrobione',
    'suggestedAction.failed': 'Nie udało się tego zrobić.',
    'suggestedAction.empty': 'Nie ma tu nic wartego zrobienia — ta rozmowa nie wymaga żadnego kroku.',
    'suggestedAction.error': 'Nie udało się przygotować tej propozycji. Model nie odpowiedział na czas.',
    'draft.send': 'Wyślij',
    'draft.sendName': 'Wyślij szkic do {to}',
    'draft.sendEditedName': 'Wyślij poprawiony szkic do {to}',
    'draft.editHere': 'Edytuj tutaj',
    'draft.editHereName': 'Edytuj tutaj — szkic do {to}, w tej rozmowie',
    'draft.discard': 'Odrzuć',
    'draft.discardName': 'Odrzuć szkic do {to}',
    'draft.stopEditingName': 'Zakończ edycję szkicu do {to}',
    'draft.editedUnsendable':
        'Poprawionej treści nie da się jeszcze stąd wysłać — można wysłać tylko szkic w zaproponowanej postaci. Przywróć treść, aby go wysłać, albo przenieś swoje zmiany do odpowiedzi.',
    'draft.done': 'Wysłano',
    'draft.failed': 'Nie udało się tego wysłać.',
    'draft.empty': 'Nie ma czego szkicować — ostatnia wiadomość w tej rozmowie jest Twoja.',
    'draft.error': 'Nie udało się przygotować tej propozycji. Model nie odpowiedział na czas.',
    'eventProposal.label': 'Propozycja wydarzenia',
    'eventProposal.when': 'Kiedy',
    'eventProposal.duration': 'Czas trwania',
    'eventProposal.from': 'Z wątku',
    'eventProposal.add': 'Dodaj do kalendarza',
    'eventProposal.addName': 'Dodaj do kalendarza: „{title}”, {when}',
    'eventProposal.anotherTime': 'Inny termin',
    'eventProposal.anotherTimeName': 'Poproś o inny termin dla „{title}”',
    'eventProposal.anotherTimeLine': 'Znajdź inny termin dla „{title}”',
    'eventProposal.declineName': 'Odrzuć — nie dodawaj „{title}” do kalendarza',
    'eventProposal.done': 'Dodano do kalendarza',
    'eventProposal.failed': 'Nie udało się dodać tego do kalendarza.',
    'eventProposal.empty': 'W tym tygodniu nie ma wystarczająco długiego wolnego terminu — nie ma czego zaproponować.',
    'eventProposal.error': 'Nie udało się przygotować tej propozycji. Kalendarz nie odpowiedział.',
    'taskProposal.label': 'Propozycja zadania',
    'taskProposal.due': 'Termin',
    'taskProposal.from': 'Z wiadomości',
    'taskProposal.add': 'Dodaj',
    'taskProposal.addName': 'Dodaj zadanie „{title}” z terminem {due}',
    'taskProposal.addNameUndated': 'Dodaj zadanie „{title}”',
    'taskProposal.declineName': 'Odrzuć zadanie „{title}”',
    'taskProposal.done': 'Dodano do zadań',
    'taskProposal.failed': 'Nie udało się dodać zadania.',
    'taskProposal.empty': 'Nic w tej rozmowie nie ma daty ani osoby odpowiedzialnej.',
    'taskProposal.error': 'Nie udało się przygotować tej propozycji. Lista zadań nie odpowiedziała.',
    'proposal.needsConfirmation': 'wymaga potwierdzenia',
    'proposal.done': 'zrobione',
    'proposal.notDone': 'nie zrobiono',
    'proposal.declined': 'odrzucone',
    'proposal.declinedLine': 'Odrzucono — nic nie zostało zrobione',
    'proposal.decline': 'Odrzuć',
    'proposal.tryAgain': 'Spróbuj ponownie',
    'proposal.tryAgainName': 'Spróbuj ponownie: {title}',
    'proposal.retryName': 'Spróbuj ponownie: {block}',
    'proposal.openCalendar': 'Otwórz kalendarz',
    'proposal.openThread': 'Otwórz wątek',
    'proposal.lookName': '{look} — opuszcza rozmowę, możesz od razu do niej wrócić',
    'proposal.refused.unauthenticated':
        'Sesja wygasła, zanim to zostało rozstrzygnięte. Zaloguj się ponownie i odpowiedz jeszcze raz.',
    'proposal.refused.unauthorized': 'To konto nie może odpowiadać na propozycje agenta.',
    'proposal.refused.unavailable':
        'Serwer nie odpowiedział, więc nic nie zostało zrobione. Spróbuj ponownie, gdy wróci.',
    'proposal.refused.unreadable':
        'Nie udało się odczytać odpowiedzi serwera, więc nie wiadomo tutaj, co się z tym stało. Zgłoś to jako błąd.',
    'proposal.refused.missing': 'Na tę propozycję już odpowiedziano albo już jej nie ma.',
    ...
    'intent.ask': 'Zapytaj',
    'intent.threadPlaceholder': 'Zapytaj o wątek albo przygotuj odpowiedź…',
    'intent.draftReply': 'Przygotuj odpowiedź',
    'intent.draftReplyShort': 'Odpowiedź',
    ...
    'folders.parent': 'Wewnątrz',
    'folders.parentTop': 'Najwyższy poziom skrzynki {mailbox}',
    'folders.kind': 'Rodzaj folderu',
    'folders.kindOrdinary': 'Zwykły folder',
    'folders.kindHint': 'Folder, według którego skrzynka porządkuje pocztę, dostaje nazwę od MailFathom.',
    'folders.role.inbox': 'Skrzynka odbiorcza',
    'folders.role.archive': 'Archiwum',
    'folders.role.drafts': 'Folder szkiców',
    'folders.role.sent': 'Folder wysłanych',
    'folders.role.junk': 'Folder spamu',
    ...
    'folders.nameTaken': 'Ta skrzynka ma już folder o tej nazwie w tym samym miejscu.',
    'folders.nestedInItself': 'Folderu nie można umieścić w nim samym.',
    'folders.actFailed': 'Nie udało się zmienić folderu: {reason}.',
    'folders.actRefused': 'Zmiana została odrzucona. {reason}',
    'folders.actStopped': 'Zmiana jest już w drodze i zamknięcie tego jej nie cofnie.',

    'folders.refusal.gone':
        'Ta skrzynka nie ma już tego folderu. Otwórz skrzynki ponownie, aby zobaczyć, co w niej jest.',
    'folders.refusal.restoring':
        'Ta skrzynka jest przywracana na serwer pocztowy i do zakończenia tego jej folderów nie można zmieniać.',
    'folders.refusal.protectedRole': 'To folder, według którego skrzynka porządkuje pocztę, i zostaje bez zmian.',
    'folders.refusal.nameInvalid': 'Ta nazwa zawiera znak, którego folder nie może nosić, albo jest za długa.',
    'folders.refusal.inboxName': 'Folder na najwyższym poziomie skrzynki nie może nazywać się jak skrzynka odbiorcza.',
    'folders.refusal.tooManyFolders': 'Ta skrzynka ma już tyle folderów, ile mieści.',
    'folders.refusal.serverRefused': 'Serwer pocztowy odrzucił tę zmianę.',
    'folders.refusal.serverUnavailable':
        'Serwer pocztowy nie odpowiedział. Nic się nie zmieniło, więc spróbuj ponownie.',
    'folders.refusal.roleAlreadyPlayed': 'Ta skrzynka ma już taki folder.',
    'folders.refusal.notYours': 'Ten folder ustawił administrator wdrożenia i to on go zmienia.',
    'folders.refusal.notRecorded':
        'Serwer pocztowy wykonał zmianę, a MailFathom nie zdołał jej zapisać. Otwórz skrzynki ponownie, zanim poprosisz o cokolwiek innego.',
    'folders.refusal.another': 'Wdrożenie ją odrzuciło.',

    'folders.deleteQuestion': 'Usunąć folder {folder}?',
    'folders.deleteConsequence': 'Folder {folder} zniknie ze skrzynki {mailbox}.',
    'folders.deleteTakesNested': 'Foldery wewnątrz niego znikną razem z nim.',
    'folders.deleteMayEraseMail':
        'To, co stanie się z pocztą w tym folderze, zależy od tego, jak przechowywana jest ta skrzynka: poczta może trafić do kosza, zostać usunięta tutaj albo także na serwerze pocztowym. Dowiesz się, co się stało.',

    'folders.creating': 'Tworzenie folderu {folder} w skrzynce {mailbox}…',
    'folders.saving': 'Zmienianie folderu {folder} w skrzynce {mailbox}…',
    'folders.removing': 'Usuwanie folderu {folder} ze skrzynki {mailbox}…',
    'folders.created': 'Utworzono folder {folder} w skrzynce {mailbox}.',
    'folders.renamed': 'Zmieniono nazwę na {folder} w skrzynce {mailbox}.',
    'folders.moved': 'Przeniesiono folder {folder} w skrzynce {mailbox}.',
    'folders.renamedNotMoved':
        'Zmieniono nazwę folderu na {folder}, ale nie udało się go przenieść. Został tam, gdzie był.',
    'folders.movedToTrash': 'Folder {folder} trafił do kosza wraz z całą zawartością.',
    'folders.erased': 'Usunięto folder {folder}. Poczta, którą zawierał, jest właśnie usuwana.',
    'folders.deleted': 'Usunięto folder {folder} na serwerze pocztowym. Poczta z niego pobrana została usunięta.',
    'folders.markedDeleted': 'Folder {folder} zniknął z MailFathom. Serwer pocztowy nadal ma ten folder i jego pocztę.',
    'folders.erasureDeferred':
        'Poczta z folderu {folder} jest nadal przechowywana i nie pojawia się na żadnej liście. Zostanie usunięta przy najbliższym przebiegu tej skrzynki.',
    ...
    'compose.aiPrompt': 'Czego ma dotyczy\u0107 szkic',
    'compose.aiPromptPlaceholder':
        'Napisz, o co chodzi \u2014 np. \u201eprzyjmujemy SLA 2 h, ale prosimy o 5% czapki na indeksacj\u0119\u201d',
    'compose.aiWrite': 'Napisz szkic',
    'compose.aiShorten': 'Skr\u00f3\u0107',
    'compose.aiExpand': 'Rozwi\u0144',
    'compose.aiFixLanguage': 'Popraw j\u0119zyk',
    'compose.aiTone': 'Ton',
    'compose.aiToneFormal': 'Formalny',
    'compose.aiToneNeutral': 'Neutralny',
    'compose.aiToneDirect': 'Bezpo\u015bredni',
    'compose.aiContext': 'Kontekst: {context}',
    'compose.aiContextNothing': 'nowa wiadomo\u015b\u0107',
    'compose.aiStaysLocal': 'szkic zostaje tutaj, dop\u00f3ki go nie wy\u015blesz',
    'compose.aiDrafting': 'AI pisze szkic\u2026',
    'compose.aiDraftShown': 'Szkic AI \u2014 sprawd\u017a fakty i ton, zanim wy\u015blesz',
    'compose.aiRestore': 'Przywr\u00f3\u0107 moj\u0105 wersj\u0119',
    'compose.aiAccept': 'Przyjmij',
    'compose.notDraftedTitle': 'Nie powsta\u0142 \u017caden szkic',
    'compose.notDrafted':
        'Twoje wdro\u017cenie tym razem nie napisa\u0142o szkicu. To, co napisane, zosta\u0142o nietkni\u0119te \u2014 zostaje napisa\u0107 to samemu.',
    'compose.draftAllowanceSpent':
        'Twoje wdro\u017cenie wyczerpa\u0142o na teraz to, na co pozwala swojemu autorowi. Osoba prowadz\u0105ca wdro\u017cenie mo\u017ce to podnie\u015b\u0107, a nic z napisanego nie zosta\u0142o tkni\u0119te.',
    'compose.cautionUnreadDraft':
        'To, co tu stoi, jest szkicem od wdro\u017cenia, kt\u00f3rego jeszcze nie przyj\u0119to.',
    'compose.words': 'Treść',
    'compose.wordsPlaceholder': 'Napisz wiadomość',
    'compose.formatting': 'Formatowanie tekstu',
    'compose.formattingHide': 'Ukryj formatowanie',
    'compose.formattingHint': 'Formatowanie działa na zaznaczonym fragmencie.',
    'compose.formatBold': 'Pogrubienie',
    'compose.formatItalic': 'Kursywa',
    'compose.formatUnderline': 'Podkreślenie',
    'compose.formatStrikethrough': 'Przekreślenie',
    'compose.formatBulletedList': 'Lista punktowana',
    'compose.formatNumberedList': 'Lista numerowana',
    'compose.formatQuote': 'Cytat',
    'compose.formatLink': 'Wstaw link',
    'compose.formatClear': 'Wyczyść formatowanie',
    'compose.linkAddress': 'Adres linku',
    'compose.linkAddressPlaceholder': 'Dokąd prowadzi link',
    'compose.insertLink': 'Wstaw',
    ...
    'compose.withdrawnTitle': 'Wiadomość wycofana',
    'compose.notWithdrawnTitle': 'Nie udało się wycofać wiadomości',
    ...
    'grant.writeContacts':
        'To poświadczenie nie może zmieniać książki adresowej w tym wdrożeniu, więc nie oferujemy dodawania kontaktu, przejmowania zebranego ani usuwania. Osoba prowadząca wdrożenie może nadać takie uprawnienie.',
    ...
    'pendingChange.flag': 'Oflagowanie',
    'pendingChange.unflag': 'Zdjęcie flagi',
    'pendingChange.markUnread': 'Oznaczenie jako nieprzeczytane',
    'pendingChange.archive': 'Archiwizacja',
    'pendingChange.delete': 'Usunięcie',
    'pendingChange.move': 'Przeniesienie do innego folderu',
    'pendingChange.putBack': 'Przywrócenie na miejsce',
    ...
    'pendingChange.notFlagged.one': 'Jedna wiadomość nie została oflagowana.',
    'pendingChange.notFlagged.few': '{count} wiadomości nie zostały oflagowane.',
    'pendingChange.notFlagged.many': '{count} wiadomości nie zostało oflagowanych.',
    'pendingChange.notFlagged.other': '{count} wiadomości nie zostało oflagowanych.',
    'pendingChange.notUnflagged.one': 'Z jednej wiadomości nie zdjęto flagi.',
    'pendingChange.notUnflagged.few': 'Z {count} wiadomości nie zdjęto flagi.',
    'pendingChange.notUnflagged.many': 'Z {count} wiadomości nie zdjęto flagi.',
    'pendingChange.notUnflagged.other': 'Z {count} wiadomości nie zdjęto flagi.',
    'pendingChange.notMarkedUnread.one': 'Jedna wiadomość nie została oznaczona jako nieprzeczytana.',
    'pendingChange.notMarkedUnread.few': '{count} wiadomości nie zostały oznaczone jako nieprzeczytane.',
    'pendingChange.notMarkedUnread.many': '{count} wiadomości nie zostało oznaczonych jako nieprzeczytane.',
    'pendingChange.notMarkedUnread.other': '{count} wiadomości nie zostało oznaczonych jako nieprzeczytane.',
    'pendingChange.notArchived.one': 'Jedna wiadomość nie została zarchiwizowana.',
    'pendingChange.notArchived.few': '{count} wiadomości nie zostały zarchiwizowane.',
    'pendingChange.notArchived.many': '{count} wiadomości nie zostało zarchiwizowanych.',
    'pendingChange.notArchived.other': '{count} wiadomości nie zostało zarchiwizowanych.',
    'pendingChange.notDeleted.one': 'Jedna wiadomość nie została usunięta.',
    'pendingChange.notDeleted.few': '{count} wiadomości nie zostały usunięte.',
    'pendingChange.notDeleted.many': '{count} wiadomości nie zostało usuniętych.',
    'pendingChange.notDeleted.other': '{count} wiadomości nie zostało usuniętych.',
    'pendingChange.notFiled.one': 'Jedna wiadomość nie została przeniesiona.',
    'pendingChange.notFiled.few': '{count} wiadomości nie zostały przeniesione.',
    'pendingChange.notFiled.many': '{count} wiadomości nie zostało przeniesionych.',
    'pendingChange.notFiled.other': '{count} wiadomości nie zostało przeniesionych.',
    'pendingChange.notPutBack.one': 'Jedna wiadomość nie została przywrócona na miejsce.',
    'pendingChange.notPutBack.few': '{count} wiadomości nie zostały przywrócone na miejsce.',
    'pendingChange.notPutBack.many': '{count} wiadomości nie zostało przywróconych na miejsce.',
    'pendingChange.notPutBack.other': '{count} wiadomości nie zostało przywróconych na miejsce.',
    ...
    'notifications.deleteSelected': 'Usuń',
    'notifications.deleteOneQuestion': 'Usunąć powiadomienie?',
    'notifications.deleteOneConsequence': '„{title}” zniknie z centrum powiadomień.',
    'notifications.deleteManyQuestion': 'Usunąć powiadomienia?',
    'notifications.deleteManyConsequence.one': '{count} powiadomienie zniknie z centrum.',
    'notifications.deleteManyConsequence.few': '{count} powiadomienia znikną z centrum.',
    'notifications.deleteManyConsequence.many': '{count} powiadomień zniknie z centrum.',
    'notifications.deleteManyConsequence.other': '{count} powiadomienia zniknie z centrum.',
    'notifications.deleteIsFinal':
        'Usuniętego powiadomienia nie da się przywrócić, a w opisanej przez nie poczcie nic się nie zmienia.',
    'notifications.keepNotification': 'Zostaw',
    'notifications.notDeleted': 'Nie udało się usunąć tych powiadomień. Zostają w takim stanie, w jakim były.',
    ...
    'notifications.said.mailArrived.title': 'Nowa poczta',
    'notifications.said.mailArrived.body.one': 'Przyszła {count} nowa wiadomość.',
    'notifications.said.mailArrived.body.few': 'Przyszły {count} nowe wiadomości.',
    'notifications.said.mailArrived.body.many': 'Przyszło {count} nowych wiadomości.',
    'notifications.said.mailArrived.body.other': 'Przyszło {count} nowych wiadomości.',
    'notifications.said.synchronizationIncomplete.title': 'Nie udało się pobrać części poczty',
    'notifications.said.synchronizationIncomplete.body.one':
        'Nie ukończono {count} z {outOf} folderu. MailFathom spróbuje ponownie.',
    'notifications.said.synchronizationIncomplete.body.few':
        'Nie ukończono {count} z {outOf} folderów. MailFathom spróbuje ponownie.',
    'notifications.said.synchronizationIncomplete.body.many':
        'Nie ukończono {count} z {outOf} folderów. MailFathom spróbuje ponownie.',
    'notifications.said.synchronizationIncomplete.body.other':
        'Nie ukończono {count} z {outOf} folderów. MailFathom spróbuje ponownie.',
    'notifications.said.credentialRefused.title': 'To konto wymaga ponownego zalogowania',
    'notifications.said.credentialRefused.body':
        'Serwer pocztowy odrzucił dane logowania, które przechowuje MailFathom, więc poczta z tego konta nie jest już pobierana.',
    'notifications.said.calendarReminderDue.title': 'Przypomnienie: {subject}',
    'notifications.said.taskReminderDue.title': 'Przypomnienie: {subject}',
    'reminders.title': 'Przypomnienia',
    'reminders.about': '{subject} — {anchor}',
    'reminders.anchor.eventTime': 'przed godziną wydarzenia',
    'reminders.anchor.eventDay': 'o 09:00 w dniu wydarzenia',
    'reminders.anchor.taskDueDate': 'o 09:00 w dniu terminu',
    'reminders.count.off': 'wyłączone',
    'reminders.count.one': '{count} przypomnienie',
    'reminders.count.few': '{count} przypomnienia',
    'reminders.count.many': '{count} przypomnień',
    'reminders.count.other': '{count} przypomnienia',
    'reminders.lead.atTheTime': 'o tej godzinie',
    'reminders.lead.onTheDay': 'w tym dniu',
    'reminders.lead.minutes.one': '{count} min wcześniej',
    'reminders.lead.minutes.few': '{count} min wcześniej',
    'reminders.lead.minutes.many': '{count} min wcześniej',
    'reminders.lead.minutes.other': '{count} min wcześniej',
    'reminders.lead.hours.one': '{count} godzinę wcześniej',
    'reminders.lead.hours.few': '{count} godziny wcześniej',
    'reminders.lead.hours.many': '{count} godzin wcześniej',
    'reminders.lead.hours.other': '{count} godziny wcześniej',
    'reminders.lead.days.one': '{count} dzień wcześniej',
    'reminders.lead.days.few': '{count} dni wcześniej',
    'reminders.lead.days.many': '{count} dni wcześniej',
    'reminders.lead.days.other': '{count} dnia wcześniej',
    'reminders.remaining.now': 'Zaczyna się teraz.',
    'reminders.remaining.minutes.one': 'Została {count} minuta.',
    'reminders.remaining.minutes.few': 'Zostały {count} minuty.',
    'reminders.remaining.minutes.many': 'Zostało {count} minut.',
    'reminders.remaining.minutes.other': 'Zostało {count} minuty.',
    'reminders.remaining.hours.one': 'Została {count} godzina.',
    'reminders.remaining.hours.few': 'Zostały {count} godziny.',
    'reminders.remaining.hours.many': 'Zostało {count} godzin.',
    'reminders.remaining.hours.other': 'Zostało {count} godziny.',
    'reminders.remaining.days.one': 'Został {count} dzień.',
    'reminders.remaining.days.few': 'Zostały {count} dni.',
    'reminders.remaining.days.many': 'Zostało {count} dni.',
    'reminders.remaining.days.other': 'Zostało {count} dnia.',
    'reminders.unit.minutes': 'min',
    'reminders.unit.hours': 'godz.',
    'reminders.unit.days': 'dni',
    'reminders.custom.count': 'Ile wcześniej',
    'reminders.custom.hint': 'np. 45',
    'reminders.custom.unit': 'Jednostka',
    'reminders.custom.add': 'Dodaj',
    'reminders.remove': 'Usuń: {lead}',
    'reminders.none.event': 'Brak przypomnienia — nie dostaniesz powiadomienia o tym wydarzeniu.',
    'reminders.none.task': 'Brak przypomnienia — nie dostaniesz powiadomienia o tym zadaniu.',
    'reminders.raises': 'Każde przypomnienie trafia do centrum powiadomień i pojawia się w rogu ekranu.',
    'reminders.turnAllOff': 'Wyłącz wszystkie',
    ...
    'people.books': 'Która książka adresowa',
    'people.own': 'Własne',
    'people.collected': 'Zebrane',
    'people.ownHint': 'książka adresowa',
    'people.collectedHint': 'z nagłówków odebranej poczty',
    'people.ownEmpty': 'Nie zapisałeś jeszcze nikogo. Dodaj kontakt, a pojawi się tutaj.',
    'people.collectedEmpty': 'Z Twojej poczty nie zebrano jeszcze nikogo.',
    'people.list': 'Kontakty',
    'people.count.one': '{count} osoba',
    'people.count.few': '{count} osoby',
    'people.count.many': '{count} osób',
    'people.count.other': '{count} osoby',
    'people.reading': 'Czytamy książkę adresową…',
    'people.readingMore': 'Czytamy dalej…',
    'people.readAgain': 'Spróbuj ponownie',
    'people.failedUnauthenticated':
        'Twoja sesja nie jest już przyjmowana, więc nie udało się odczytać książki adresowej. Zaloguj się ponownie.',
    'people.failedUnauthorized':
        'To poświadczenie nie może czytać książki adresowej w tym wdrożeniu. Osoba prowadząca wdrożenie może nadać takie uprawnienie.',
    'people.failedUnavailable':
        'Wdrożenie nie odpowiedziało książką adresową. Może być niedostępne albo dopiero się uruchamia.',
    'people.failedUnreadable':
        'Wdrożenie odpowiedziało książką adresową, której ten klient nie potrafi odczytać. Warto zgłosić to jako usterkę.',

    'people.newContact': 'Nowy kontakt',
    'people.closeNewContact': 'Zamknij',
    'people.contactName': 'Nazwa',
    'people.contactAddress': 'Adres e-mail',
    'people.addressNotUsable': 'To nie wygląda na adres e-mail.',
    'people.newContactHint':
        'Kontakt, który zapiszesz, możesz zmieniać i usuwać. To wdrożenie przechowuje nazwę i adresy, i nic więcej o osobie.',
    'people.saveContact': 'Zapisz kontakt',

    'people.write': 'Napisz',
    'people.writeMessage': 'Napisz wiadomość',
    'people.openContact': 'Otwórz kontakt',
    'people.selectContacts': 'Zaznacz kontakty',
    'people.deleteContact': 'Usuń kontakt',
    'people.deleteContacts': 'Usuń kontakty',
    'people.selectionBar': 'Zaznaczone kontakty',
    'people.clearSelection': 'Wyczyść zaznaczenie',
    'people.backToList': 'Wróć do książki adresowej',
    'people.nobodyOpen': 'Otwórz kogoś, aby przeczytać jego stronę.',
    'people.collectedReadOnly': 'Tylko do odczytu — edytowalny po dodaniu do kontaktów',
    'people.promote': 'Dodaj do moich kontaktów',
    'people.promoting': 'Dodajemy…',

    'people.eraseOne': 'Usunąć ten kontakt?',
    'people.eraseMany': 'Usunąć {count} kontaktów?',
    ...
    'people.originRefuses': 'Tego kontaktu nie możesz zmieniać.',
    'people.alreadyAsserted': 'Ten kontakt jest już jednym z Twoich.',
    'people.writeFailed': 'Wdrożenie nie odpowiedziało, więc nic nie zostało zmienione.',

    'person.relationship': 'Stan relacji',
    'person.authored': 'AI',
    'person.relationshipPending': 'MailFathom nie pisze jeszcze odczytu relacji.',
    'person.lastContact': 'Ostatni kontakt',
    'person.neverInTouch': 'Z tą osobą nie wymieniono poczty.',
    'person.sharedThreads': 'Wspólne wątki',
    'person.documents': 'Dokumenty od tej osoby',
    'person.noThreads': 'Żadna rozmowa tutaj nie wymienia tej osoby.',
    'person.noDocuments': 'Ta osoba nie wysłała żadnych plików.',
    'person.unnamedDocument': 'Plik bez nazwy',
    'person.correspondenceReading': 'Czytamy…',
    'person.correspondenceAgain': 'Spróbuj ponownie',
    'person.correspondenceUnauthenticated':
        'Twoja sesja nie jest już przyjmowana, więc nie udało się tego odczytać. Zaloguj się ponownie.',
    'person.correspondenceUnauthorized': 'To poświadczenie nie może czytać tego, gdzie ta osoba jest wymieniona.',
    'person.correspondenceUnavailable': 'Wdrożenie nie odpowiedziało.',
    'person.correspondenceUnreadable':
        'Wdrożenie odpowiedziało czymś, czego ten klient nie potrafi odczytać. Warto zgłosić to jako usterkę.',
    'person.correspondenceMissing': 'Tej osoby nie ma już w książce adresowej.',

    'calendar.day': 'Dzień',
    'calendar.week': 'Tydzień',
    'calendar.month': 'Miesiąc',
    'calendar.agenda': 'Agenda',
    'calendar.views': 'Który widok',
    'calendar.previous': 'Wcześniej',
    'calendar.next': 'Później',
    'calendar.today': 'Dziś',
    'calendar.weekCovered': '{days} · tydzień {week}',
    'calendar.drawnAsAgenda': 'Na tej szerokości nie mieszczą się kolumny, więc te same dni są wypisane listą.',
    'calendar.dayEvents': 'Wydarzenia: {day}',
    'calendar.hourEvents': 'Wydarzenia o {hour}',
    'calendar.openDay': 'Otwórz {day}',
    'calendar.nothingInSpan': 'Nie ma tu nic w kalendarzu.',
    'calendar.fromMail': 'Z poczty',
    'calendar.reading': 'Czytamy kalendarz…',
    'calendar.readAgain': 'Spróbuj ponownie',
    'calendar.failedUnauthenticated':
        'Twoja sesja nie jest już przyjmowana, więc nie udało się odczytać kalendarza. Zaloguj się ponownie.',
    'calendar.failedUnauthorized': 'To poświadczenie nie może czytać kalendarza.',
    'calendar.failedUnavailable':
        'Wdrożenie nie odpowiedziało kalendarzem. Może być wyłączone albo dopiero się uruchamia.',
    'calendar.failedUnreadable':
        'Wdrożenie odpowiedziało czymś, czego ten klient nie potrafi odczytać. Warto zgłosić to jako usterkę.',
    'calendar.proposedHeading': 'Wykryte w poczcie',
    'calendar.authored': 'AI',
    'calendar.proposedExplained': 'Terminy znalezione w wątkach, jeszcze nieobecne w kalendarzu.',
    'calendar.nothingProposed': 'Twoja poczta niczego nie zaproponowała.',
    'calendar.acceptProposal': 'Dodaj',
    'calendar.dismissProposal': 'Odrzuć',
    'calendar.proposalDismissed': 'Odrzucone.',
    'calendar.eventAllDay': 'Cały dzień',
    'calendar.eventReminders': 'Przypomnienia',
    'calendar.newEvent': 'Nowe wydarzenie',
    'calendar.closeNewEvent': 'Zamknij',
    'calendar.describeEvent': 'Opisz wydarzenie, a MailFathom wypełni pola',
    'calendar.describeExample': 'obiad z Anną w czwartek o trzynastej',
    'calendar.describeAct': 'Odczytaj opis',
    'calendar.describing': 'Czytamy…',
    'calendar.describeDrafted': 'Wypełnione z Twojego opisu. Sprawdź, zanim zapiszesz.',
    'calendar.describeNothing': 'Nie udało się z tego odczytać wydarzenia. Spróbuj podać dzień i godzinę.',
    'calendar.describeSpent': 'To wdrożenie zużyło na razie limit na czytanie opisów.',
    'calendar.describeFailed': 'Wdrożenie nie odpowiedziało, więc nic nie zostało wypełnione.',
    'calendar.eventTitle': 'Tytuł',
    'calendar.eventDay': 'Dzień',
    'calendar.eventStart': 'Początek',
    'calendar.eventEnd': 'Koniec',
    'calendar.saveEvent': 'Zapisz',
    'calendar.amendEvent': 'Edytuj',
    'calendar.closeEvent': 'Zamknij',
    'calendar.openEvent': 'Otwórz wydarzenie',
    'calendar.openSource': 'Otwórz wiadomość',
    'calendar.kindOwn': 'Twoje',
    'calendar.kindFromMail': 'Z poczty',
    'calendar.selectEvents': 'Zaznacz wydarzenia',
    'calendar.selectionBar': 'Co zrobić z zaznaczonymi wydarzeniami',
    'calendar.clearSelection': 'Wyczyść zaznaczenie',
    'calendar.deleteEvent': 'Usuń wydarzenie',
    'calendar.deleteEvents': 'Usuń',
    'calendar.deleteOne': 'Usunąć to wydarzenie?',
    'calendar.deleteMany': 'Usunąć wydarzenia: {count}?',
    'calendar.deletePermanent': 'Znikną z kalendarza i nie da się ich przywrócić.',
    'calendar.deleteAct': 'Usuń z kalendarza',
    'calendar.deleted': 'Usunięte.',
    'calendar.deleteSomeRefused': 'Części z nich nie udało się usunąć.',
    'calendar.written': 'Zapisane.',
    'calendar.writeNotFound': 'Tego wydarzenia nie ma już w kalendarzu.',
    'calendar.writeRefused': 'Wdrożenie nie przyjęło tego wydarzenia. Sprawdź tytuł i godziny.',
    'calendar.alreadyOnTheCalendar': 'Ten termin jest już w kalendarzu.',
    'calendar.writeFailed': 'Wdrożenie nie odpowiedziało, więc nic nie zostało zmienione.',
    'tasks.newTask': 'Nowe zadanie',
    'tasks.showDone': 'Pokaż zrobione',
    'tasks.groupToday': 'Dziś',
    'tasks.groupThisWeek': 'W tym tygodniu',
    'tasks.groupLater': 'Później',
    'tasks.reading': 'Wczytywanie…',
    'tasks.readingMore': 'Wczytywanie dalszych…',
    'tasks.readAgain': 'Spróbuj ponownie',
    'tasks.empty':
        'Lista jest pusta. Zadanie zapisane tutaj albo odczytane przez MailFathom z poczty pojawi się pod dniem, na który przypada.',
    'tasks.allDone': 'Wszystko na liście jest zrobione. Włącz „Pokaż zrobione”, żeby to zobaczyć.',
    'tasks.failedUnauthenticated':
        'Twoja sesja nie jest już przyjmowana, więc nie udało się wczytać listy. Zaloguj się ponownie.',
    'tasks.failedUnauthorized': 'To poświadczenie nie może czytać Twoich zadań.',
    'tasks.failedUnavailable': 'Wdrożenie nie odpowiedziało.',
    'tasks.failedUnreadable':
        'Wdrożenie odpowiedziało czymś, czego ten klient nie potrafi odczytać. Warto zgłosić to jako usterkę.',
    'tasks.fromMail': 'z poczty',
    'tasks.openSource': 'Otwórz wiadomość, z której to pochodzi',
    'tasks.noDay': 'Bez dnia',
    'tasks.dueOn': 'Na {day}',
    'tasks.accept': 'Przyjmij',
    'tasks.schedule': 'Zaplanuj',
    'tasks.scheduling': 'Zapisywanie w kalendarzu…',
    'tasks.inTheCalendar': 'W kalendarzu',
    'tasks.selectRow': 'Zaznacz {title}',
    'tasks.markDoneRow': 'Oznacz {title} jako zrobione',
    'tasks.markNotDoneRow': 'Oznacz {title} jako niezrobione',
    'tasks.addReminder': 'Dodaj przypomnienie do {title}',
    'tasks.remindersOnRow': 'Przypomnienia dla {title}: {count}',
    'tasks.selectTasks': 'Zaznacz zadania',
    'tasks.markDone': 'Oznacz jako zrobione',
    'tasks.markNotDone': 'Oznacz jako niezrobione',
    'tasks.scheduleInCalendar': 'Zaplanuj w kalendarzu',
    'tasks.openSourceThread': 'Otwórz wątek źródłowy',
    'tasks.deleteTask': 'Usuń zadanie',
    'tasks.declineTask': 'Odrzuć zadanie',
    'tasks.selectionBar': 'Działania na zaznaczonych zadaniach',
    'tasks.clearSelection': 'Anuluj zaznaczenie',
    'tasks.deleteTasks': 'Usuń',
    'tasks.eraseQuestion.one': 'Usunąć to zadanie?',
    'tasks.eraseQuestion.few': 'Usunąć {count} zadania?',
    'tasks.eraseQuestion.many': 'Usunąć {count} zadań?',
    'tasks.eraseQuestion.other': 'Usunąć {count} zadania?',
    'tasks.erasePermanent': 'Tego nie da się cofnąć.',
    'tasks.eraseAct': 'Usuń',
    'tasks.markedDone': 'Oznaczono jako zrobione.',
    'tasks.markedNotDone': 'Oznaczono jako niezrobione.',
    'tasks.accepted': 'Dodano do Twoich zadań.',
    'tasks.erased': 'Usunięto.',
    'tasks.scheduled': 'Wpisano do kalendarza.',
    'tasks.written': 'Zapisano.',
    'tasks.remindersWritten': 'Zapisano przypomnienia.',
    'tasks.nothingToSchedule': 'Nic tutaj nie wskazuje dnia, więc nie ma czego wpisać do kalendarza.',
    'tasks.writeFailed': 'Wdrożenie tego nie przyjęło. Nic nie zostało zmienione.',
    'tasks.writeFailedBecause': 'Wdrożenie tego nie przyjęło: {reason}. Nic nie zostało zmienione.',
    'tasks.someRefused.one': 'Wdrożenie odrzuciło jedno z nich. Reszta przeszła.',
    'tasks.someRefused.few': 'Wdrożenie odrzuciło {count} z nich. Reszta przeszła.',
    ...
    'tasks.dayFailedUnauthenticated':
        'Twoja sesja nie jest już przyjmowana, więc nie udało się wczytać dnia. Zaloguj się ponownie.',
    'tasks.dayFailedUnauthorized': 'To poświadczenie nie może czytać Twojego kalendarza.',
    'tasks.dayFailedUnavailable': 'Wdrożenie nie odpowiedziało.',
    'tasks.dayFailedUnreadable':
        'Wdrożenie odpowiedziało dniem, którego ten klient nie potrafi odczytać. Warto zgłosić to jako usterkę.',
    'tasks.authored': 'AI',
    'tasks.dayCapacity': 'Pojemność dnia',
    'tasks.capacityTasks.one': 'Na dziś przypada jedno zadanie.',
    'tasks.capacityTasks.few': 'Na dziś przypadają {count} zadania.',
    'tasks.capacityTasks.many': 'Na dziś przypada {count} zadań.',
    'tasks.capacityTasks.other': 'Na dziś przypada {count} zadania.',
    'tasks.capacityEvents.one': 'Kalendarz trzyma już jedno wydarzenie.',
    'tasks.capacityEvents.few': 'Kalendarz trzyma już {count} wydarzenia.',
    'tasks.capacityEvents.many': 'Kalendarz trzyma już {count} wydarzeń.',
    'tasks.capacityEvents.other': 'Kalendarz trzyma już {count} wydarzenia.',
    'tasks.layOutToday': 'Rozplanuj dziś',
    'tasks.arranging': 'Rozplanowywanie reszty dnia…',
    'tasks.notArranged': 'W tym, co zostało z dnia, nie było czego rozplanować.',
    'tasks.allowanceSpent': 'To wdrożenie wyczerpało dzisiejszy limit zapytań do dostawcy. Spróbuj jutro.',
    'tasks.arrangeFailed': 'Nie udało się rozplanować dnia. Nic nie zostało zmienione.',
    'tasks.unnamedPlacement': 'Zadanie, którego nie ma już na liście',
    'tasks.notToday.one': 'Jedno zadanie nie zmieściło się w tym, co zostało z dnia.',
    'tasks.notToday.few': '{count} zadania nie zmieściły się w tym, co zostało z dnia.',
    'tasks.notToday.many': '{count} zadań nie zmieściło się w tym, co zostało z dnia.',
    'tasks.notToday.other': '{count} zadania nie zmieściło się w tym, co zostało z dnia.',
    'tasks.addToCalendar': 'Dodaj do kalendarza',
    'tasks.addingToCalendar': 'Dodawanie…',
    'tasks.putTheOfferDown': 'Zostaw',
    'tasks.closeNewTask': 'Zamknij',
    'tasks.taskTitle': 'Co trzeba zrobić',
    'tasks.taskDueOn': 'Dzień',
    'tasks.saveTask': 'Zapisz',
};
