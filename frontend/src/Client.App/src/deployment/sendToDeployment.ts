...
// convention. This module is the whole of the transport that answers with text; `attachmentExchange.ts` beside it is
// what answers with octets instead, which is why it is a second module rather than a second export.
