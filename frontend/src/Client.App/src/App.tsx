...
export function App({
    ...
    return (
        // Outermost of all, because the surface it answers is mounted above this frame: how long a notification stands
        // is the person's, and the only place their answer exists is here — so it is stated once at the top and every
        // screen below reaches it through the hook rather than carrying the number itself.
