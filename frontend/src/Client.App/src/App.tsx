...
export function App({
    ...
    return (
        ...
        <ReadMarkingProvider session={session} transport={readMail} marking={markingRead}>
            {/* Above the frame for the same reason: which of the two reading surfaces a message opens on decides how
            every message anywhere below is drawn, and the two components that read it — the body and the control on
            the message head — sit several levels under the reading pane and under the conversation alike. */}
