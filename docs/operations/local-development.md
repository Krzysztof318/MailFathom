...
| Image description | A Polish receipt whose words carry their diacritics, and a sign printed in Polish and in English, each held to its words as printed rather than translated |
