...
- `dotnet format` runs when the change touches `src/**`, `tests/**`, `.editorconfig`, or the workflow file. It restores `MailMcp.slnx` and verifies repository formatting without applying changes.
