...
`mailfathom.mail.flags.write`, `mailfathom.mail.move`, `mailfathom.mail.delete`, `mailfathom.mail.drafts.write`, `mailfathom.mail.send`, `mailfathom.mail.accounts.write`, or on the administrative endpoint one of the administrative names
