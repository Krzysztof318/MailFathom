...
| `mfctl account custody show --account <id>` | Reports which copy of that account's mailbox is the truth, and how much of its source server is still to be emptied |
