...
| `…:<n>:Basic:AttemptsPerMinute` | int | `10` | Password attempts one source and one username each get per minute, replenished continuously and spent only by a wrong password; `1` to `600` | restart |
