...
flag misdescribes mail the owner can still find in the folder they left it in; a wrong move puts the mail somewhere
...
worth naming rather than leaving to the ungoverned default: the first two write to the owner's real mail server, the
