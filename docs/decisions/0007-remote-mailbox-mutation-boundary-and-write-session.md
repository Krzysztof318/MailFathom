...
- [ADR 0034](0034-holding-a-mailbox-mailfathom-alone-keeps.md) leaves this record governing a mirrored account unchanged, and amends axes A, J, and K for the source of an account that holds its own mailbox: the drain expunge and the restore append.
