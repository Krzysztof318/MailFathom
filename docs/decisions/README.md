...
- [0017: Select the content backend once per deployment, write the object before the row that points at it, and name an object after the row that owns it](0017-object-storage-content-backend-consistency-and-object-identity.md)
